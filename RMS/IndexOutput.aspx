...
<html>
	...
	<head>	
		<title>营业额报表导出-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
		<meta charset="utf-8" />
	...
	<body onload="printtable()">
		<div class="title"><h1>营业额报表</h1></div>
		...
		<script>
			function printtable(){
			    ...
			    var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0001","paras":[{"name":"starttime","value":"' + _startime + ' 00:00:00"},{"name":"endtime","value":"' + _endtime + ' 23:59:59"}]}]';
