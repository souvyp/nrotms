...
<html>
<head>		
<title>运输订单(委托)-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
               <p class="mainHtml_tit">运输订单(委托)</p>
            </div>
			<!-- 操作面板 -->
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        function OsCarriage()
        {
            var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0005","paras":[]}]';
