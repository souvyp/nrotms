...
<html>
	...
	<head>	
		<title>收入支出报表导出-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
		<meta charset="utf-8" />
	...
	<body onload="printtable()">
		<div class="title"><h1>收入支出报表</h1></div>
				...
				function(result, data) {
					if(result) {
						for(var i=0;i<data[0].rs[0].rows.length;i++){
							$("tbody").append("<tr style='page-break-after:always;'><td>"+data[0].rs[0].rows[i].TotalPrime+"</td><td>"
