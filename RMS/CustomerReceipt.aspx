...
<html>
<head>		
<title>客户回单统计-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<body code="CustomerReceipt" onload="getdate()">
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
    			<p class="mainHtml_tit" style="float: left;">客户回单统计</p>	
			...
			<div class="jplist-panel box panel-top min_height">
				<div class="text-filter-box">
					...
					<button type="button" id="btn_click" onclick="CusRec()"><i class="glyphicon glyphicon-search"></i></button>
				</div>
