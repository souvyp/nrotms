...
<html>
<head>		
<title>待结账客户单-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
            ...
            function ( result, data )
            {
                if ( result )
                {
                    ...
                    if ( length != 0 )
                    {
                        ...
                        {
                            _html += '<tr>';
                            _html += '<td title="'+ data[0].rs[0].rows[i].Code + '">' + data[0].rs[0].rows[i].Code + '</td><td title="'+ data[0].rs[0].rows[i].CustomerName + '">' + data[0].rs[0].rows[i].CustomerName + '</td>';
