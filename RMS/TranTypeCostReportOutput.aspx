...
<html>
	...
	<head>	
		<title>运输类型成本报表导出-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
		<meta charset="utf-8" />
	...
	<body onload="printtable()">
		<div class="title"><h1>运输类型成本报表</h1></div>
				...
				function(result, data) {
					if(result) {
						for(var i=0;i<data[0].rs[0].rows.length;i++){
							$("tbody").append("<tr style='page-break-after:always;'><td>"+data[0].rs[0].rows[i].TransportModeName+"</td><td>"
