...
<html>
<head>		
<title>应付结账信息-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<body code="CopeReport" onload="getdate()">
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
               <p style="float: left;" class="mainHtml_tit">应付结账</p>
               <div style="float: right;" class="btn btn-red footKeepBtn" onclick="PrintArea()" id="printbtn">打印&nbsp;<span class="glyphicon glyphicon-print"></span></div>
	           <a style="float: right;margin:5px;position:relative;bottom:5px" class="btn btn-red footKeepBtn" target="_blank"  onclick="CopeReportOutput(this)" id="printbtn">导出&nbsp;<span class="glyphicon glyphicon-new-window"></span></a>
            </div>
			<!-- 操作面板 -->
			<div class="jplist-panel box panel-top min_height">
				<div class="text-filter-box hide">
					...
					<button type="button" id="btn_click" onclick="TurnoverStat()"><i class="glyphicon glyphicon-search"></i></button>
				</div>
			...
			<div>
	                    ...
	                    <div class=""><!-- block right -->
		                    <table class="jptable table table-border">
                                ...
                                <tbody class="jplistYL">
				                    <tr class="" name="CopeReport" >
                                        <td class="" view-fld='{fld:"CustomerName",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"1",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"2",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"3",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"4",method:"show"}'></td>
										<td class="" view-fld='{fld:"5",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"6",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"7",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"8",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"9",method:"show"}'></td>
										<td class="" view-fld='{fld:"10",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"11",method:"show"}'></td>
										<td class="" view-fld='{fld:"12",method:"show"}'></td>
					                    <td class="" view-fld='{fld:"TotalCost",method:"show"}'></td>
				                    </tr>
			                    </tbody>
		                    </table>
	                    </div>
				...
				<!-- no result found -->
				<div class="text-pos box jplist-no-results text-shadow align-center hide">
...
<script>	
	...
	function getData()
	{
		$('tr[name="CopeReport"]').attr('view-id','{ id:"rms_0015",cross:"false", rowIdentClass:"CopeReport", paras:[{"name":"Year","value":"'+ Year +'"},{"name":"rows","value":10},{"name":"page","value":1}]}')
		var _AllList = new NSF.System.Data.Grid();		
		_AllList.Pagination("first-ds-pag", $("div[name='first-ds-pag']"),"page");
		_AllList.Initialize("/", "CopeReport", $("tr[name='CopeReport']").attr("view-id"), $("tr[name='CopeReport']"));
		if( !$('tr').hasClass('CopeReport') )
			$('.jplist-no-results').removeClass('hide');
	}
	function page(page) {
		$('tr[name="CopeReport"]').attr( 'view-id', '{ id:"rms_0015",cross:"false", rowIdentClass:"CopeReport", paras:[{"name":"Year","value":"'+ Year +'"},{"name":"rows","value":10},{"name":"page","value":'+ page +'}]}');
		getData();
	}
