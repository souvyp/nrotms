...
<html>
<head>		
<title>实际利润月报表-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<body code="ActualPMR" onload="getdate()">
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
	<div id="demo" class="box jplist">
        ...
        <div class="maintitle_container">
           <p style="float: left;" class="mainHtml_tit">实际利润月报表</p>
           ...
           <a style="float: right;margin:5px;position:relative;bottom:5px" class="btn btn-red footKeepBtn" target="_blank"  onclick="ActualPMROutput(this)" id="printbtn">导出&nbsp;<span class="glyphicon glyphicon-new-window"></span></a>
        </div>
		<!-- 操作面板 -->
