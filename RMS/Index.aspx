...
<html>
<head>		
<title>营业额-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<body code="Index" onload="getdate()">
<!-- 通用对话框开始-->
			...
			<div class="modal-body">
				<div class="content">
					<div class="modal-header">
		                ...
		                <h3 class="modal-title" id="win-Common-DialogLabel"></h3>	
	               </div>
					<div class="modal-body">
					</div>
		            <div class="modal-footer">
		                <button type="button" class="btn btn-red footKeepBtn" onclick="">确认</button>
		            </div>
				</div>
			</div>
		</div>
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
    			<p class="mainHtml_tit" style="float: left;">营业额报表</p>
	           ...
	           <a style="float: right;margin:5px;position:relative;bottom:5px" class="btn btn-red footKeepBtn" target="_blank"  onclick="IndexOutput(this)" id="printbtn">导出&nbsp;<span class="glyphicon glyphicon-new-window"></span></a>
            </div>
			<!-- 操作面板 -->
