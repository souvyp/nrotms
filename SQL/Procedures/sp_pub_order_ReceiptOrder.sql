...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_pub_order_ReceiptOrder]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_pub_order_ReceiptOrder]
GO
...
/*¶©µ¥»Øµ¥*/
CREATE PROCEDURE [dbo].[sp_pub_order_ReceiptOrder]
(
	@Operator BIGINT,
	@OrderID BIGINT,
