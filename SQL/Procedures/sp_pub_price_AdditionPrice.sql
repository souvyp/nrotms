...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_pub_price_AdditionPrice]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_pub_price_AdditionPrice]
GO
...
附加费
*/
CREATE PROCEDURE [dbo].[sp_pub_price_AdditionPrice]
(
	@Operator BIGINT,
	@DocID BIGINT,							-- 报价单号
...
BEGIN
	...
	/* 补充报价可以是负数TDQ BUG 2402 20161108
