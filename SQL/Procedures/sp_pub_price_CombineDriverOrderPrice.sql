...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_pub_price_CombineDriverOrderPrice]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_pub_price_CombineDriverOrderPrice]
GO
...
/*合单报价*/
CREATE PROCEDURE [dbo].[sp_pub_price_CombineDriverOrderPrice]
(
	@OpenId NVARCHAR(300),
	@DocID BIGINT,
