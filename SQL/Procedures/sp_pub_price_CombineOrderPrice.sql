...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_pub_price_CombineOrderPrice]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_pub_price_CombineOrderPrice]
GO
...
/*合单报价*/
CREATE PROCEDURE [dbo].[sp_pub_price_CombineOrderPrice]
(
	@Operator BIGINT,
	@DocID BIGINT,
