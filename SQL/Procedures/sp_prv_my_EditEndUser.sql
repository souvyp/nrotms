...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_prv_my_EditEndUser]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_prv_my_EditEndUser]
GO
...
*/
CREATE PROCEDURE [dbo].[sp_prv_my_EditEndUser]
(
	@Operator BIGINT,
