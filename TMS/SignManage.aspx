...
<html>
<head>		
<title>签收管理-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
       ...
       <div class="modal-dialog">
          <div class="modal-content">
               ...
               <%-- <button type="button" class="close" 
                ...
                <div class="modal-footer" style="position:absolute; top:0; width:100%; padding-bottom:0;">
                    <button type="button" class="btn btn-default  okButton footKeepBtn" style="margin-right:8px; box-shadow:none;text-shadow:none;" aria-label="OK" title="确定" onclick="SignOrderAuto($(this).next().val())" ><span aria-hidden="true" class="">确定</span><span class="glyphicon glyphicon-ok" style="margin-left:2px;"></span></button>
                    <input type="hidden" name="OrderID">
		...
		<table class="jptable  table" id="demoList">
			...
			{{each data}}
				<tr>
					...
					<td class="title" title="{{$value.code}}" fld="code"><a  href="SignManage_edit.aspx?id={{$value.id}}">{{$value.code}}</a></td>
                    ...
                    <td class="title">
                        <button type="button" title="签收订单" onclick="IsSend({{$value.id}})" style="margin-left:0;">签收</button>
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "SignManage", "/Widget.aspx?param=jplist&vid=grid_jplist_0039");
