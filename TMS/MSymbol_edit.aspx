        ...
        <table class="FormTable Y_alter FormTable6" style="width: 100%;" id="7cff24c8-129a-4746-8c7d-55b22bd37199" path="OTMS/rjwqhugn" code="rjwqhugn">
            ...
            <tbody>
                ...
                <tr class="" style="height: 26px;">
                    ...
                    <td class="" colspan="3" >
  						        <ul class="edit form-control list-inline" name="type" type="radio" f-options="{'code':'type','type':'radio','etype':'editable','len':'1','cls':'list','url':'发货方\r\n承运方','id':'','text':''}" verify="{}">
                        <li>
                          <input type="radio" name="type" value="2" class="edit-list transparent">承运方
                        </li>
                      </ul>
                    </td>
                </tr>
