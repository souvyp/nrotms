...
<body code="SupplierSelector" style="width:800px">
<!-- 通用对话框开始-->
		...
		<table class="jptable table" id="demoList">
			...
			{{each data}}
				<tr onDblClick="dblEvents()">
	                ...
	                <td class="title" fld="name" style="text-align:left;"  title="{{$value.name}}">{{$value.name}}</td>
		...
		<div id="demo" class="box jplist">
			...
			<div class="jplist-panel box panel-top min_height">
				...
				<div class="text-filter-box">
					...
					<input data-path="name" data-button="#name-search-button" type="text" value="" placeholder="标识名称" data-control-type="textbox" data-control-name="name" data-control-action="filter">
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "SupplierSelector", "/Widget.aspx?param=jplist&vid=grid_jplist_0083");
