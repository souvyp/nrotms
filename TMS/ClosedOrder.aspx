		...
		<table class="jptable  table" id="demoList">
			...
			{{each data}}
				<tr>
					...
					<td class="title" title="{{$value.code}}" fld="code"><a target="_blank" href="ClosedOrder_edit.aspx?id={{$value.id}}">{{$value.code}}</a></td>
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "ClosedOrder", "/Widget.aspx?param=jplist&vid=grid_jplist_0034");
