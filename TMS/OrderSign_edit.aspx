...
<body code="OrderSign">
   ...
   aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <table class="FormTable Y_alter readForm" style="width: 100%;" id="ef41d4b8-88a5-4954-9d0d-b1dc6a71f860" path="OTMS/eofxvafl" code="eofxvafl">
            ...
            <tbody>
                ...
                <tr style="height: 26px; display: none;" class="" fb-options="{'rowid':'TMS_OrderGoods','initialRows':'1','maxrows':'10','content':''}" rowid="TMS_OrderGoods">
                    <td colspan="">
                        <input type="text" title="物品编号" readonly oc="dialogue" class="edit form-control transparent" name="GoodsID" f-options="{'code':'id','type':'dialogue','etype':'editable','len':'50','cls':'frame','url':'../GoodsSelector.aspx','vals':'GoodsID=GoodsID,OrderID=id','modalWindow':'1'}" verify="{}">
                ...
                <tr style="height: 26px;">
                      ...
                      <td ></td>
                      <td class="hu_td_so">
                        <input  style="cursor:text !important; " name="TotalReceiptQty" readonly onblur="realSign(this)" title="" placeholder="" oc="number" class="edit form-control transparent" >
                         
                        <input style="cursor:text !important; border-left: 1px solid #e1e6eb;" readonly onblur="realSign(this)" name="TotalExceptionQty" title="" placeholder="" oc="number" class="edit form-control transparent" >
                      </td>
                </tr>
               <tr>
                    <td rowspan="1" colspan="9" style="background-color: white; border: 0; height: 15px;"></td>
    ...
    <script src="/assets/js/jquery-1.11.1.min.js"></script><script type="text/javascript" src="js/index.js"></script>
