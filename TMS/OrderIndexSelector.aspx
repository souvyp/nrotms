...
<html>
<head>		
<title>原始订单选择-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<body code="OrderIndexSelector" style="width:800px">
<!-- 通用对话框开始-->
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "OrderIndexSelector", "/Widget.aspx?param=jplist&vid=grid_jplist_0006");
