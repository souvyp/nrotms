...
<html>
<head>    
<title>长途合单信息-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
 ...
 <table class="FormTable Y_alter line_chaidan" style="width:100%;" id="25ccf24c-9c73-44a5-899b-2565511d81d0" path="Price/eyxhzqmm" code="eyxhzqmm" > 
      ...
      <td colspan="6" style="border:0;">
        ...
        <div class="toolbar">
          <div style="text-align:right;" class="button_workflow">
            <a class="btn btn-red footKeepBtn" href="javascript:void(0);" onclick="CombineOrders(1,2)">发送&nbsp;<span class="glyphicon glyphicon-send"></span></a>
            <a class="btn btn-red footKeepBtn" href="javascript:void(0);" onclick="CombineOrders(0,2)">保存为草稿&nbsp;<span class="glyphicon glyphicon-floppy-disk"></span></a>
  ...
  <tr style="height: 26px;">
    ...
    <tr style="height: 26px; display: none;"  class="" fb-options="{'rowid':'MinPrice','initialRows':'','maxrows':'','content':''}" rowid="OrderContains">
      ...
      <td class="">
        <a href="javascript:void(0);" tar="OrderContains" onclick="deleteOrder(this)" class="button edit" executecode="%23delete%23"  f-options="{'code':'','type':'_button','etype':'','len':''}" verify="{'title':'','length':'','textarea1':true}">删除</a>
      </td>
    </tr>
...
<script type="text/javascript">
    ...
    function _DoPageLoad() {
        initTableForm($('#25ccf24c-9c73-44a5-899b-2565511d81d0'), false, function(){
          setTimeout( "hoverTips();autoHead();ifChecked();totalOrderData()", 500 );
        });
    }
