...
<html>
<head>
    <title>已委托订单详情-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
    <meta charset="utf-8" />
...
<body code="Commissioned">
    ...
    <div class="formcontainer" style="display: none;">
        ...
        <script language="javascript">
            var __saveNdtCfg = '{"main":{"insertVml":"","updateVml":"","queryVml":"tms_0027"},"TMS_OrderGoods":{"insertVml":"tms_0028","updateVml":"tms_0028","queryVml":"tms_0030","deleteVml":"tms_0031"},"TMS_OrderCost":{"insertVml":"","updateVml":"","queryVml":"tms_0077","deleteVml":""}}';
        </script>
        <table class="FormTable Y_alter FormTable6 readForm" style="width: 100%;" id="ef41d4b8-88a5-4954-9d0d-b1dc6a71f860" path="OTMS/eofxvafl" code="eofxvafl">
            ...
            <tbody>
                <tr class="td-container tr-fixed">
                    ...
                    <div style="padding-top:20px;" >
                            <div style="padding-left: 3px; background-color: #f27302;">
                                <p style="background-color: white; padding-left: 8px; height: 20px; line-height: 20px; margin-bottom: 25px;">已委托订单详情</p>
                            </div>
                        </div>
                    </td>
                ...
                <tr style="height: 26px; display: none">
                    <td class="styleCenter" rowspan="1" colspan="9" style="font-size: 18px;">
                ...
                <tr style="height: 26px;" class="" fb-options="{'rowid':'','initialRows':'','maxrows':'','content':''}">
                    ...
                    <td class="td_name" style="text-align: right;">异常数量</td>
                </tr>
                <tr style="height: 26px; display: none;" class="" fb-options="{'rowid':'TMS_OrderGoods','initialRows':'1','maxrows':'10','content':''}" rowid="TMS_OrderGoods">
                    ...
                    <td class="styleCenter">
                        <input name="ReceiptQty" title="实签数量" oc="number" readonly class="edit form-control transparent" f-options="{'code':'ReceiptQty','type':'number','etype':'editable','len':'50'}" verify="{}">
                    </td>
                    <td class="" style="text-align: right;">
                        <input name="ExceptionQty" title="异常数量" oc="number" readonly class="edit form-control transparent" f-options="{'code':'ExceptionQty','type':'number','etype':'editable','len':''}" verify="{}">
                    </td>
                </tr>
                ...
                <tr style="height: 26px;" >
                	<td class=""  colspan="3">合计</td>
                    <td >
                    	<input name="TotalQty" readonly title="数量合计" oc="text" class="edit form-control transparent" >
                    </td>
                    <td >
                    	<input name="TotalWeight" readonly title="重量合计" oc="text" class="edit form-control transparent" >
                    </td>
                    <td >
                    	<input name="TotalVolume" readonly title="体积合计" oc="text" class="edit form-control transparent" >
                    </td>
                      <td ></td>
                      <td ></td>
                      <td ></td>                    
    ...
    <script type="text/javascript">
        function _DoPageLoad()
        {
            ...
            {
                setTimeout('GoodsCategory();ReceiptDocPath();status_list();CarTypes( $( \'input[name="CarType"]\' ).val() );YesORno();PackageMode();ShipModeName();TransportMode();', 500);
                ifChecked();
                ifBoxChecked();
                setTimeout('Calculator();', 800);
            } );
        }
