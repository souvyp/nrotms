...
<body code="PriceManage">
        ...
        <table class="FormTable Y_alter FormTable6 readForm" style="width: 100%;" id="ef41d4b8-88a5-4954-9d0d-b1dc6a71f860" path="OTMS/OrderPrice" code="OrderPrice">
            ...
            <tbody>
                ...
                <tr style="height: 26px;">
                    ...
                    <td class="" rowspan="1" colspan="3">
                        <input name="SupplierName" readonly title="标记名称" class="edit form-control transparent" placeholder="SupplierName" oc="text" readonly class="edit form-control transparent" f-options="{'code':'SupplierSymbolName','type':'text','etype':'editable','len':'600'}" verify="{'title':'承运方标记名称','length':'600','required':true}">
                    </td>
                </tr>
                <tr style="height: 26px;">
                ...
                <tr style="height: 26px;" class="" fb-options="{'rowid':'','initialRows':'','maxrows':'','content':''}">
                    ...
                    <td class="td_name" colspan="">单品总重量（公斤）</td>
                    <td class="td_name" colspan="">单品总体积（立方米）</td>
    ...
    <script type="text/javascript">
        function _DoPageLoad()
        {
            ...
            {
                setTimeout( 'CarTypes( $( \'input[name="CarType"]\' ).val() );YesORno();PackageMode();ShipModeName();TransportMode();GoodsCategory(); Sum();', 300 );  
