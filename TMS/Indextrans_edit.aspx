...
<html>
<head>
    <title>运输订单信息-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
    <meta charset="utf-8" />
        ...
        <table class="FormTable Y_alter FormTable6 readForm" style="width: 100%;" id="ef41d4b8-88a5-4954-9d0d-b1dc6a71f860" path="OTMS/eofxvafl" code="eofxvafl">
            ...
            <tbody>
                    ...
                    <td class="text-left" rowspan="1" colspan="4" style="font-size: 14px; border: 0; border-bottom: 1px solid #e1e6eb; padding-right: 0; padding-left: 0;width:100% !important;">
                        <div style="padding-top:20px;" >
                            <div style="padding-left: 3px; background-color: #f27302;">
                                <p style="background-color: white; padding-left: 8px; height: 20px; line-height: 20px; margin-bottom: 25px;width:100% !important;">运输订单信息</p>
                            </div>
                        </div>
                    </td>
                    <td colspan="5" style="border: 0;">
                        ...
                        <div class="toolbar">
                            <div style="text-align: right;" class="button_workflow">
                                <a class="btn btn-red footKeepBtn print" onclick="skipto()">打印&nbsp;<span class="glyphicon glyphicon-print"></span></a>
                ...
                <tr>
                    ...
                    <td class="" rowspan="1" colspan="3">
                        <input name="Payment" title="预付款"  class="writeInput" placeholder="" readonly oc="text" class="edit form-control transparent data" f-options="{'code':'Payment','type':'text','etype':'editable','len':'600'}" verify="{'title':'预付款','length':'600'}">
                    </td>
                    <td class="td_name" colspan="1">货到付款</td>
                    <td colspan="4">
                        <input name="Payable"   class="edit form-control transparent data" readonly f-options="{'code':'Payable','type':'richtext','etype':'','len':''}" verify="{'title':'货到付款','length':'','textarea1':true}"></input>
                    </td>                    
                </tr>
                <tr>
                    <td rowspan="1" colspan="9" style="background-color: white; border: 0; height: 15px;"></td>
                ...
                <tr style="height: 26px;display: none" class="addition">
                      <td class="td_name"  colspan="5">补差</td>
    ...
    <script type="text/javascript">
        ...
        var reqeustDone = function () {		/*所有JS加载完成以后执行*/
            ...
            initTableForm( $( '#ef41d4b8-88a5-4954-9d0d-b1dc6a71f860' ), false, function ()
            {
                ...
                ShipModeName();
                TransportMode();
                setTimeout("Sum();hoverTips()", 300);        /*合计*/
            } );

            $('body').attr('code', getUrlParam('code'));

            if (getUrlParam('code') == 'Commissioned') {
                $('.print').addClass('hide');
            }
        };
