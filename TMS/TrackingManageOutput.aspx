...
<html>
	...
	<head>	
		<title>运输订单导出-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
		<meta charset="utf-8" />
	...
	<body onload="printtable()">
		<div class="title"><h1>运输订单日报表</h1></div>
		...
		<script>
			function printtable(){
				...
				var vml ='[{"namespace":"protocol","cmd":"data","version":1,"id":"tms_0229","paras":'+ unescape(_data) +'}]';
						...
						for(var i=0;i<data[0].rs[0].rows.length;i++){
							...
							if(j==14||(j-14)%16==0){
									$("tbody").append("<tr style='page-break-after:always;'><td>"+data[0].rs[0].rows[i].code+"</td><td>"
												...
												+data[0].rs[0].rows[i].ContainsOwnerOrderCode+"</td><td>"
