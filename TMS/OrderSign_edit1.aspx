...
<body code="OrderSign">
   ...
   aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <table class="FormTable Y_alter readForm" style="width: 100%;" id="ef41d4b8-88a5-4954-9d0d-b1dc6a71f860" path="OTMS/eofxvafl" code="eofxvafl">
            ...
            <tbody>
                ...
                <tr style="height: 26px;">
                    ...
                    <td class="" rowspan="1" colspan="4">
                        <input name="DeviceCode" title="设备编号" class="writeInput" readonly placeholder="设备编号" oc="text" class="edit form-control transparent" f-options="{'code':'DeviceCode','type':'text','etype':'editable','len':'600'}" verify="{'title':'设备编号','length':'600','required':true}">
                    </td>
                </tr>
                <tr style="height: 26px;">
                ...
                <tr style="height: 26px; display: none;" class="" fb-options="{'rowid':'TMS_OrderGoods','initialRows':'1','maxrows':'10','content':''}" rowid="TMS_OrderGoods">
                    <td colspan="">
                        <input type="text" title="物品编号" oc="dialogue" class="edit form-control transparent" name="GoodsID" f-options="{'code':'id','type':'dialogue','etype':'editable','len':'50','cls':'frame','url':'../GoodsSelector.aspx','vals':'GoodsID=GoodsID,OrderID=id','modalWindow':'1'}" verify="{}">
                    ...
                    <td class="hu_td_so">
                        <input  style="cursor:text !important; " name="ReceiptQty" onkeyup="calTotalSign(this)" onblur="realSign(this)" title="实签数量" placeholder="请输入实签数量" oc="number" class="edit form-control transparent" f-options="{'code':'ReceiptQty','type':'number','etype':'editable','len':'50'}" verify="{'title':'ReceiptQty','length':'50','required':true,'number':true}">
                   		 
                        <input style="cursor:text !important; border-left: 1px solid #e1e6eb;" onkeyup="calTotalSign(this)" onblur="realSign(this)" name="ExceptionQty" title="异常数量" placeholder="请输入异常数量" oc="number" class="edit form-control transparent" f-options="{'code':'ExceptionQty','type':'number','etype':'editable','len':''}" verify="{'title':'ExceptionQty','length':'50','required':true,'number':true}">
                    </td>
                </tr>
                ...
                <tr   style="height: 26px;" class="" >
                    <td colspan="3" class="td_name">合计</td>
                     <td>
                        <input name="TotalWeight" title="总重量"  readonly  oc="text"  class="edit form-control transparent" f-options="{'code':'','type':'text','etype':'calculation','len':'50'}" verify="">
                    </td>
                    <td>
                        <input name="TotalVolume" title="总体积" readonly  oc="text" class="edit form-control transparent" f-options="{'code':'','type':'text','etype':'editable','len':'50'}" verify="">
                    </td>
                    <td >
                        <input name="TotalQty" title="总数量" readonly oc="text"  class="edit form-control transparent"  f-options="{'code':'','type':'text','etype':'editable','len':'50'}" verify="">
                    </td>
                     <td>
                        <input name="GoodsValue" title="总实签数量"   oc="text" class="edit form-control transparent" f-options="{'code':'GoodsValue','type':'number','etype':'editable','len':''}" 
                    </td>
                    <td class="hu_td_so">
                        <input  style="cursor:text !important; " name="TotalReceiptQty" readonly title="实签数量" oc="number" class="edit form-control transparent" >
                         
                        <input style="cursor:text !important; border-left: 1px solid #e1e6eb;" readonly  name="TotalExceptionQty" title="异常数量"  oc="number" class="edit form-control transparent" >
                    </td>
                </tr>
               <tr>
                    <td rowspan="1" colspan="9" style="background-color: white; border: 0; height: 15px;"></td>
    ...
    <script type="text/javascript">
        function initFooter()
        {
            $( 'div[class="sidebar-title"]' ).find( 'span:eq(0)' ).css( 'top', '13px' );
        }
    </script>
    <!--通用页尾结尾-->
    ...
    <script type="text/javascript">
        function _DoPageLoad()
        {
            ...
            {
                setTimeout( 'GoodsCategory();status_list();YesORno();PackageMode();ShipModeName();TransportMode();SignVal()', 300 );
        ...
        var _jsUrl = "/Minify.aspx?jcss=%2fassets%2fNSF%2fjs%2fNSF.0.0.3.min.js%3a%2fassets%2fjs%2fcommon.js%3a%2fassets%2fplugins%2fuploadFile%2fjquery.uploadify.js%3a%2fassets%2fplugins%2fbootstrap%2fjs%2fbootstrap.min.js%3a%2fassets%2fjs%2ftemplate.js%3a%2fassets%2fplugins%2fstore%2fstore.js%3a%2fassets%2fplugins%2fbootstrap%2fjs%2fbootstrap-select.min.js%3a%2fassets%2fplugins%2fjstree%2fdist%2fjstree.min.js%3a%2fassets%2fplugins%2flaydate%2flaydate.js%3a%2fassets%2fjs%2fdroparea.js%3a%2fassets%2fplugins%2fbootstrap-wysihtml5%2fwysihtml5-0.3.0.js%3a%2fassets%2fplugins%2fbootstrap-wysihtml5%2fbootstrap-wysihtml5.js%3a%2fassets%2fplugins%2fbootstrap-markdown%2fjs%2fbootstrap-markdown.js%3a%2fassets%2fkindeditor%2fkindeditor.js%3a%2fassets%2fkindeditor%2flang%2fzh_CN.js%3a%2fassets%2fkindeditor%2fplugins%2fcode%2fprettify.js%3a%2fassets%2fjs%2fCSDU.1.0.1.min.js%3a%2fassets%2fplugins%2fjquery.PrintArea.js%3a%2fassets%2fbootstrap%2fjs%2fbootstrap-datetimepicker.min.js%3a%2fassets%2fbootstrap%2fjs%2fbootstrap-datetimepicker.zh-CN.js%3a%2fjs%2flogin.js%3a%2fjs%2flogin-ui.js%3a%2fPMS%2fcity%2fjs%2fpublic.js%3a%2fassets%2fjs%2fdrag.js&ver=100";
    </script>
