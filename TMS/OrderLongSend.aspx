...
<html>
<head>		
<title>长途待调度订单-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
		...
		<div id="demo" class="box jplist">
			...
			<div class="jplist-panel box panel-top min_height">
                ...
                <div class="" style="height:30px;float:left;padding:10px 10px 0px 0px">
                        <input type="text" name="cityName" readonly placeholder="收货地址(省/市)" class="city_input inputFocus proCitySelAll"/><!---->
                        ...
                        <%--<input name="ToDistrict" type="hidden" class="edit form-control transparent"  data-path="ToDistrict" data-button="#search-button" data-control-type="textbox" data-control-name="ToDistrict" data-control-action="filter">                --%>
...
<!--通用页尾开始-->
<!--市区模糊搜索-->
<!--ul class="dropdown-menu" id="citySeach">
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "OrderSend", "/Widget.aspx?param=jplist&vid=grid_jplist_0059",false,checkboxList);
