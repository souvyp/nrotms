...
<html>
<head>
    <title>已关闭订单信息-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
    <meta charset="utf-8" />
...
<body code="ClosedOrder">
            ...
            <tbody>
                <tr class="td-container tr-fixed">
                    ...
                    <div style="padding-top:20px;" >
                            <div style="padding-left: 3px; background-color: #f27302;">
                                <p style="background-color: white; padding-left: 8px; height: 20px; line-height: 20px; margin-bottom: 25px;">已关闭订单信息</p>
                            </div>
                        </div>
                    </td>
                ...
                <%--<tr style="height: 26px;">--%>
                    ...
                    <%--<td rowspan="1" colspan="8">--%>
                        <%--<input type="file" title="头像" oc="image" class="edit form-control droparea spot" name="ReceiptDocPath" data-post="/ImageUploader.aspx?filename=ReceiptDocPath" data-width="50" data-height="50" data-crop="true" f-options="{'code':'ReceiptDocPath','type':'image','etype':'editable','len':'50'}" verify="{}">--%>
                    <%--</td>--%>
                <%--</tr>--%>
    ...
    <script type="text/javascript">
        ...
        var reqeustDone = function () {		/*所有JS加载完成以后执行*/
            ...
            //setTimeout("GoodsCategory();ReceiptDocPath()", 1000);
        };
