		...
		<table class="jptable table" id="demoList">
			...
			{{each data}}
				<tr>
                    ...
                    <td class="title">
                    	<button class="btn btn-link" title="提交纸质回单" onclick="IsHd({{$value.id}})" style="margin-left:0;margin-right:3px;color:#f27302;">回单</button>
                        <button type="button" title="追加备注" onclick="addComment({{$value.id}})" style="margin-right:5px;">备注</button>
                        <button class="btn btn-link" title="打回订单" onclick="IsBackOrder({{$value.id}})" style="margin-left:0;margin-right:5px;">打回</button>
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "OrderReceipt", "/Widget.aspx?param=jplist&vid=grid_jplist_0009");
