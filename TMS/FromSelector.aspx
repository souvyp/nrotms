...
<body code="FromSelector" style="width:800px">
<!-- 通用对话框开始-->
		...
		<table class="jptable table" id="demoList">
			...
			{{each data}}
				<tr onDblClick="dblEvents()">
					...
					<td class="title" fld="FromName">{{$value.FromName}}</td>
                    ...
                    <td style="display:none;" class="title" fld="ProvinceName">{{$value.ProvinceName}}</td>
                    <td style="display:none;" class="title" fld="CityName">{{$value.CityName}}</td>
                    <td style="display:none;" class="title" fld="DistrictName">{{$value.DistrictName}}</td>
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "FromSelector", "/Widget.aspx?param=jplist&vid=grid_jplist_0091");
