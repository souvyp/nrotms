        ...
        <table class="FormTable Y_alter readForm" style="width: 100%;" id="ef41d4b8-88a5-4954-9d0d-b1dc6a71f860" path="OTMS/eofxvafl" code="eofxvafl">
            ...
            <tbody>
                ...
                <tr style="height: 26px; display: none;" class="" fb-options="{'rowid':'TMS_OrderGoods','initialRows':'1','maxrows':'10','content':''}" rowid="TMS_OrderGoods">
                    ...
                    <td class="hu_td_so">
                        <input style="cursor:text !important;" name="ReceiptQty" onblur="realSign(this)" title="实签数量" placeholder="请输入实签数量" oc="number" class="edit form-control transparent" f-options="{'code':'ReceiptQty','type':'number','etype':'editable','len':'50'}" verify="{'title':'ReceiptQty','length':'50','required':true,'number':true}">
                 
                
                        <input style="cursor:text !important; border-left: 1px solid #e1e6eb;" onblur="realSign(this)" name="ExceptionQty" title="异常数量" placeholder="请输入异常数量" oc="number" class="edit form-control transparent" f-options="{'code':'ExceptionQty','type':'number','etype':'editable','len':''}" verify="{'title':'ExceptionQty','length':'50','required':true,'number':true}">
                    </td>
                </tr>
