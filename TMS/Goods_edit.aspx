        ...
        <table class="FormTable Y_alter FormTable6" style="width: 100%;" id="c331b75f-b1dc-4083-b74a-56eefcab2547" path="OTMS/goods" code="goods">
            ...
            <tbody>
                    ...
                    <td colspan="3" style="border:0; border-bottom:1px solid #e1e6eb;">
                        ...
                        <div class="toolbar">
                            <div style="text-align: right;" class="button_workflow">
                                <a class="btn btn-red footKeepBtn" href="javascript:void(0);" onclick="saveGoods(this)" >保存&nbsp;<span class="glyphicon glyphicon-floppy-disk"></span></a>
                ...
                <tr style="height: 26px;">
                    ...
                    <td class="td_name">
                        <a href="javascript:void(0);" onclick="showModalWindow(this,'物品类型')" class="edit" f-options="{'code':'TypeID','type':'dialogue','etype':'editable','len':'50','cls':'frame','url':'GoodsTypeSelector.aspx','vals':'TypeName=Name','modalWindow':'1'}" verify="{}">
                ...
                <tr style="height: 26px;">
                    <td class="td_name">
                        <a href="javascript:void(0);" onclick="showModalWindow(this,'所属计量单位')" class="edit" f-options="{'code':'id','type':'dialogue','etype':'editable','len':'50','cls':'frame','url':'PriceUnitSelector.aspx','vals':'Unit=id,UnitName=name','modalWindow':'1'}" verify="{}">
