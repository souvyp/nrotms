        ...
        <table class="FormTable Y_alter readForm" style="width: 100%;" id="ef41d4b8-88a5-4954-9d0d-b1dc6a71f860" path="OTMS/eofxvafl" code="eofxvafl">
            ...
            <tbody>
                ...
                <tr style="height: 26px; display: none">
                    <td class="styleCenter" rowspan="1" colspan="8" style="font-size: 18px;">
...
<script type="text/javascript">
    function _DoPageLoad()
    {
        ...
        {
            setTimeout('GoodsCategory();status_list();YesORno();PackageMode();ShipModeName();TransportMode();CarTypes( $( \'input[name="CarType"]\' ).val() ); Sum();images();', 300);
        } );
    }
