	...
	<div class=""><!-- block right -->
        ...
        <div class="jplist-panel box panel-top min_height">
            ...
            <div class="text-filter-box">
                    ...
                    <button type="button" id="CodeButton" onclick="QueryOrdersByCode( $(this).prev().val(), 2 )">
                         <i class="glyphicon glyphicon-search"></i>
                     </button>
			</div>
		</div>
		<div class="jplist-panel box panel-top min_height" style="margin-top:10px;">
			<table class="jptable  table" id="demoList" style="margin-top:0 !important;">
				<thead>
					<tr class="trtitle">
				...
				<tbody>
					<tr style="display:none" name="orderList" >
						<td class="title" view-fld='{fld:"Code", method:"template",template:"<a target=\"_blank\" href=\"OrderTracking_edit.aspx?id=@id@\">@code@</a>"}'></td>
