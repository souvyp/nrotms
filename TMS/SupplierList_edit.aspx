 ...
 <table class="FormTable Y_alter" style="width:100%;" id="60eeb3b4-c3e1-4225-943d-2b83f7377390" path="OTMS_TEST/eonrfvtq" code="eonrfvtq">
  ...
  <tbody>
	...
	<tr style="height: 26px;">
        ...
        <td class=""  colspan="7">
            <input class="edit form-control transparent com" readonly placeholder="根据公司编号自动获取" />
        </td>    
    ...
    <tr style="height: 100px;">
      ...
      <td colspan="7">
        <textarea name="InviteDesc" class="edit form-control transparent" placeholder="" f-options="{'code':'InviteDesc','type':'richtext','etype':'editable','len':'600'}" verify="{'title':'邀请信','length':'600','required':true}"></textarea>
      </td>
    </tr>
  </tbody>
 </table>
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        initTableForm($('#60eeb3b4-c3e1-4225-943d-2b83f7377390'),'', function() {
          $('textarea').val('诚挚邀请贵方成为我方承运方');
        }, '');
