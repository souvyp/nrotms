        ...
        <table class="FormTable Y_alter FormTable6" style="width: 100%;" id="7cff24c8-129a-4746-8c7d-55b22bd37199" path="OTMS/EnduserAddr" code="EnduserAddr">
            ...
            <tbody>
                ...
                <tr class="" style="height: 26px;">
                    <td class="td_name">
                        <a href="javascript:void(0);" onclick="showModalWindow(this,'收货方')" class="edit" f-options="{'code':'CustomerID','type':'dialogue','etype':'editable','len':'50','cls':'frame','url':'EndUserAddrSelector.aspx','vals':'CustomerName=name,CustomerID=id','modalWindow':'1'}" verify="{}">
                            <input type="hidden" name="CustomerID">收货方
                        </a>
                    </td>
                    <td class="" >
                    ...
                    <td class="" colspan="3">
            						<input name="Phone" title="联系电话" oc="text" class="edit form-control transparent" f-options="{'code':'Phone','type':'text','etype':'editable','len':'50'}" verify="{'title':'联系电话','length':'100','textarea1':true,'validate':'{\'pattern\': \'^((([0\+][0-9]{2,3}-)?(0[0-9]{2,3})-)?([0-9]{7,8})?(([0-9]{7,8})(-([0-9]{3,}))?))?(([1][3|4|5|7|8][0-9])[0-9]{8})?$\',\'message\': \'格式不正确，请重新输入！\'}'}">
                    </td>
                </tr>
                ...
                <tr style="height: 26px;">
                    ...
                    <td rowspan="1" colspan="3">
                        <input name="Address" onkeyup='this.value=this.value.replace(/[\&\?]/gi,"")' title="地址" oc="text" class="edit form-control transparent" f-options="{'code':'Address','type':'text','etype':'editable','len':'300'}" verify="{'title':'地址','length':'300','required':true}">
