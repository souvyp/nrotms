		...
		<table class="jptable  table">
			...
			<tbody>
				<tr name="MyEvents" >
                    ...
                    <td class="title" style="display:none;" name="IsDistance" view-fld='{fld:"IsDistance",method:"show"}'></td>
                    <td class="title" style="display:none;" name="Desc" view-fld='{fld:"Desc",method:"show"}'></td>
				</tr>
			</tbody>
		</table>
	</div>
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        $('tr[name="MyEvents"]').attr('view-id', '{ id:"tms_0080",cross:"false", rowIdentClass:"MyEvents", paras:[{"name":"Amount","value":20}]}');
        ...
        $('.MyEvents').each(function () {
            ...
            var _IsDistance = $(this).find('td[name="IsDistance"]').text();
            var _Desc = $(this).find('td[name="Desc"]').text();
            ...
            if (_Event_Type == '1') {
                ...
                _Event = '被拒绝的订单：' + _Event_Ext + ';'+ _Desc;
                if( _IsDistance == '0' ){
                ...
                _Event = _Event_SrcCompanyName + '已接收订单：' + _Event_Ext;
                ...
                _Event = '被拒绝的拼车单：' + _Event_Ext +';'+ _Desc;
