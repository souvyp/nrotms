        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="position:absolute; top:0; width:100%; padding-bottom:0;">
                    <button type="button" class="btn btn-default  okButton footKeepBtn" style="margin-right:8px; box-shadow:none; text-shadow:none;" aria-label="OK" title="确定" onclick="OrderReceiptEdit()"><span aria-hidden="true" class="">确定</span><span class="glyphicon glyphicon-ok" style="margin-left:2px;"></span></button>
            ...
            <tbody>
                ...
                <tr style="height: 26px; display: none;" class="" fb-options="{'rowid':'TMS_OrderGoods','initialRows':'1','maxrows':'10','content':''}" rowid="TMS_OrderGoods">
                   ...
                   <td class=""  > <!--styleCenter-->
                        <input name="ReceiptQty" title="实签数量" readonly oc="number" class="edit form-control transparent" f-options="{'code':'ReceiptQty','type':'number','etype':'editable','len':'50'}" verify="{}">
                    </td>
                    <td class="" >
                        <input name="ExceptionQty" title="异常数量" readonly oc="number" class="edit form-control transparent" f-options="{'code':'ExceptionQty','type':'number','etype':'editable','len':''}" verify="{}">
                    </td>
                </tr>
