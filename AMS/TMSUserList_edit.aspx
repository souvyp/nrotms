...
<script language="javascript">
    ...
    <form role="form" id="GeneralForm">
         <table class="FormTable Y_alter FormTable6" style="width:100%;" id="aac020bc-8346-4ed4-8241-643afe621e3d" path="OTMS_TEST/ufdkcnna" code="ufdkcnna">
          <colgroup>
          ...
          <tbody>
            ...
            <tr style="height: 26px;" class="">
              ...
              <td class="" rowspan="1" colspan="2">
                <input name="Account" readonly title="账号"  oc="text" class="edit form-control transparent" f-options="{'code':'Account','type':'text','etype':'editable','len':'50'}" verify="{}">
              </td>
              ...
              <td class="" rowspan="1" colspan="5">
                  <ul class="list-inline" style="position:relative; top:5px;">
                    <li><input type="hidden"  name="RoleID" />
                        <input type="checkbox"  class="control-check" name="RoleID_id" value="1" style="position:relative; top:2px;"/>运营</li>
                    <li><input type="checkbox"  class="control-check" name="RoleID_id" value="2" style="position:relative; top:2px;"/>客服</li>
                </ul>
              </td>
            </tr>
            <tr style="height: 26px;">
            ...
            <tr style="height: 26px;">
              ...
              <td class="" rowspan="1" colspan="2">
                <input name="Phone" title="联系电话"  oc="number" class="edit form-control transparent" f-options="{'code':'Phone','type':'number','etype':'editable','len':'15'}" verify="{'title':'phone','length':'50','textarea1':true,'validate':'{\'pattern\': \'^((([0\+][0-9]{2,3}-)?(0[0-9]{2,3})-)?([0-9]{7,8})?(([0-9]{7,8})(-([0-9]{3,}))?))?(([1][3|4|5|7|8][0-9])[0-9]{8})?$\',\'message\': \'格式不正确，请重新输入！\'}'}">
              </td>
