...
<script language="javascript">
    ...
    <form role="form" id="GeneralForm">
         <table class="FormTable Y_alter" style="width:100%;" id="aac020bc-8346-4ed4-8241-643afe621e3d" path="OTMS_TEST/FMSUserList" code="FMSUserList">
          <colgroup>
...
<%--                    <button type="button" class="btn user-submit fr" ev="%23saveNDT%23"  onclick="UserAdd()" >提交&nbsp;<span class="glyphicon glyphicon-ok-circle"></span></button>--%>
            ...
            <tr style="height: 26px;">
              ...
              <td class="" rowspan="1" colspan="2">
                <input name="Name" title="姓名" oc="text" class="edit form-control transparent" f-options="{'code':'Name','type':'text','etype':'editable','len':'100'}" verify="{'title':'姓名','length':'50','required':true}">
              </td>
            </tr>
            <tr style="height: 26px;">
