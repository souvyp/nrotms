             ...
             <div class="row">
                 <div class="col-md-6 login_margin" style="margin:auto; margin-top:150px;float: none;">
					...
					<div style="padding:20px;background:rgba(255,255,255,0.8);border-radius:0 0 5px 5px">						
						<ul class="helpList">
                            <li><a href="物流源公司管理员操作手册.pdf">物流源公司管理员操作手册</a></li>
                            <li><a href="用户创建操作指南.pdf">用户创建操作指南</a></li>
                            <li><a href="重新计算功能使用说明.pdf">重新计算功能使用说明</a></li>
                            <li><a href="创建集团用户与申请加入集团操作指南.pdf">创建集团用户与申请加入集团操作指南</a></li>
                            <li><a href="创建园区用户与申请加入园区操作指南.pdf">创建园区用户与申请加入园区操作指南</a></li>
