...
<script language="javascript">
    var __saveNdtCfg = '{"main":{"insertVml":"aml_0012","updateVml":"aml_0012","queryVml":"aml_0007"}}';
</script>
 <table class="FormTable Y_alter" style="width:100%;" id="60eeb3b4-c3e1-4225-943d-2b83f7377390" path="OTMS_TEST/eonrfvtq" code="eonrfvtq">
  ...
  <tbody>
    <tr>
      <td class="text-left" colspan="4"  style="font-size: 14px; border:0; border-bottom:1px solid #e1e6eb;padding-right:0; padding-left:0;"><div style="padding-left:3px; background-color:#f27302;"><p style="background-color:white;padding-left:8px;height:20px; line-height:20px; margin-bottom:25px; ">园区申请信息</p></div></td>
    ...
    <tr style="height: 26px;">
        ...
        <td class=""  colspan="7">
            <input name="ZoneCompanyCode" class="edit form-control transparent"   f-options="{'code':'ZoneCompanyCode','type':'text','etype':'editable','len':'100'}" verify="{'title':'园区公司编号','length':'100', 'required':true}">
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
		...
		$('input[name="ZoneCompanyCode"]').change(function()
		{
      $(this).val( $(this).val().replace(/\s/g,"") );
			NSF.System.Data.RecordSet( "/", { id:"tms_0200",cross:"false", paras:[{"name":"ClientCode","value": $(this).val() }] }, function ( result, config, data )
			{
				...
				else
				{
					...
					$('input[name="ZoneCompanyCode"]').val('');$('.com').val('');
					$('input[name="ZoneCompanyCode"]').attr('placeholder','编号对应集团不存在，请核对');
				}
			});
		});
