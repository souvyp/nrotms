...
<html>
<head>		
<title>报表系统用户-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
		...
		<table class="jptable table">
			...
			{{each data}}
				<tr>
					...
					<td class="title" fld="Name"><a href="RMSUserList_edit.aspx?id={{$value.id}}" >{{$value.Name}}</a></td>
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
               <p class="mainHtml_tit">报表/集团/园区用户</p>
            </div>
			<!-- 操作面板 -->
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "RMSUserList", "/Widget.aspx?param=jplist&vid=grid_jplist_0060");
    };
