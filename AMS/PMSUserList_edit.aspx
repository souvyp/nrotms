              ...
              <td class="" rowspan="1" colspan="5">
                  <ul class="list-inline" style="position:relative; top:5px;">
                    <li><input type="hidden"  name="RoleID" />
						<input type="checkbox"  class="control-check" name="RoleID_id" value="32" style="position:relative; top:2px;"/>采购</li>
                    <li><input type="checkbox"  class="control-check" name="RoleID_id" value="512" style="position:relative; top:2px;"/>业务员</li>
                </ul>
              </td>
            </tr>
            <tr style="height: 26px;">
