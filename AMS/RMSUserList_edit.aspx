...
<script language="javascript">
    ...
    <form role="form" id="GeneralForm">
         <table class="FormTable Y_alter FormTable6" style="width:100%;" id="aac020bc-8346-4ed4-8241-643afe621e3d" path="OTMS/RMSUserList" code="RMSUserList">
          <colgroup>
...
<%--                    <button type="button" class="btn user-submit fr" onclick="UserEdit()" >提交&nbsp;<span class="glyphicon glyphicon-ok-circle"></span></button>--%>
              ...
              <td class="" rowspan="1" colspan="5">
                  <ul class="list-inline" style="position:relative; top:5px;">
                    <li><input type="hidden"  name="RoleID" />
						<input type="checkbox"  class="control-check" name="RoleID_id" value="128" style="position:relative; top:2px;"/>老板</li>
                </ul>
              </td>
            </tr>
            <tr style="height: 26px;">
            ...
            <tr style="height: 26px;">
              ...
              <td class="" rowspan="1" colspan="2">
                <input name="Phone" title="联系电话" oc="number" class="edit form-control transparent" f-options="{'code':'Phone','type':'number','etype':'editable','len':'50'}" verify="{'title':'phone','length':'50','textarea1':true,'validate':'{\'pattern\': \'^((([0\+][0-9]{2,3}-)?(0[0-9]{2,3})-)?([0-9]{7,8})?(([0-9]{7,8})(-([0-9]{3,}))?))?(([1][3|4|5|7|8][0-9])[0-9]{8})?$\',\'message\': \'格式不正确，请重新输入！\'}'}">
              </td>
