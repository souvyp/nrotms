...
<body code="MySending" role="DocByCompact">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="position:absolute; top:0; width:100%; padding-bottom:0;">
                    <button type="button" class="btn btn-default  okButton footKeepBtn" style="margin-right:8px; box-shadow:none;text-shadow:none;" aria-label="OK" title="确定" onclick="CompactSave(this)"><span aria-hidden="true" class="">确定</span><span class="glyphicon glyphicon-ok" style="margin-left: 2px;"></span></button>
  ...
  <tbody>
      ...
      <td colspan="6" style="border: 0;">
        ...
        <div class="toolbar">
          <div style="text-align:right;" class="button_workflow">
            <a class="btn btn-red footKeepBtn" href="javascript:void(0);" onclick="CompactSave(this, 'MySending')">保存&nbsp;<span class="glyphicon glyphicon-floppy-disk"></span></a>
    ...
    <tr style="height: 26px;">
      ...
      <td class="" rowspan="1" colspan="5">
        <input name="PactCode" class="edit form-control transparent"  f-options="{'code':'PactCode','type':'text','etype':'','len':''}" verify="{'title':'合同编号','length':'100','required':true,'textarea1':true,'validate':'{\'pattern\': \'^[a-zA-Z0-9\-]*$\',\'message\': \'格式不正确，请重新输入！\'}'}" value="0">
    		...
    		<td colspan="11" style="border: 0px;border-bottom: 1px solid #ddd;padding-left:5px;">
				<ul class="list-inline ld" style="margin-bottom: 15px;" role="tablist1">
	    			...
	    			<li class="num" role="tab" data-toggle="tab" aria-controls="num">
                        ...
                        <select name="Unit_id" onchange="pushDisplayValue(this);_DoComboLinking(this);" class="edit transparent selectCarr show-tick form-control" data-live-search="true"  f-options="{'code':'','type':'combobox','etype':'','len':''}" verify="{'title':'','length':'','textarea1':true}" style="display: none;">
	    			...
	    			<li class="province"> 
                        ...
                        <input name="FromProvince" type="hidden" class="edit form-control transparent" f-options="{'code':'FromProvince','type':'text','etype':'','len':''}" verify="" value="0">
                        <input name="FromCity" type="hidden" class="edit form-control transparent" f-options="{'code':'FromCity','type':'text','etype':'','len':''}" verify="" value="0">   
                        <input name="FromDistrict" type="hidden" class="edit form-control transparent" f-options="{'code':'FromDistrict','type':'text','etype':'','len':''}" verify="" value="0">               
    ...
    <tbody id="KG" role="tab1" class="tab-pane active">
        ...
        <tr class="hide" style="height: 26px;">
            <td colspan="3" class="province">
                ...
                <input name="ToProvince" type="hidden" class="edit form-control transparent" f-options="{'code':'ToProvince','type':'text','etype':'','len':''}" verify="" value="0">
                <input name="ToCity" type="hidden" class="edit form-control transparent" f-options="{'code':'ToCity','type':'text','etype':'','len':''}" verify="" value="0"> 
                <input name="ToDistrict" type="hidden" class="edit form-control transparent" f-options="{'code':'ToDistrict','type':'text','etype':'','len':''}" verify="" value="0">                                  
                  <div class="provinceCityAll">
                      <div class="tabs clearfix">
                        <ul class="">
                          <li><a href="javascript:" class="current" tb="hotCityAll">热门城市</a></li>
    ...
    <tbody id="PMS_FullLoad" role="tab" class="tab-pane">
        <tr>
            ...
            <td class="province setOff" rowspan="1" colspan="8">			    
                <input name="FromName" type="text" readonly placeholder="请选择起点省市区" 
                 class="city_input inputFocus proCitySelAll" style="width: 280px !important;"/>
                <input name="FromProvince" type="hidden" class="edit form-control transparent data" f-options="{'code':'FromProvince','type':'text','etype':'','len':''}" verify="{}" value="0">
                <input name="FromCity" type="hidden" class="edit form-control transparent data" f-options="{'code':'FromCity','type':'text','etype':'','len':''}" verify="" value="0">
                <input name="FromDistrict" type="hidden" class="edit form-control transparent data" f-options="{'code':'FromDistrict','type':'text','etype':'','len':''}" verify="" value="0">                     
                <div class="provinceCityAll">
                  <div class="tabs clearfix">
                    <ul class="">
                      <li><a href="javascript:" class="current" tb="hotCityAll">热门城市</a></li>
        ...
        <tr nrowkey="DetailID" style="height: 26px; display: none;" class="" fb-options="{'rowid':'PMS_FullLoad','initialRows':'','maxrows':'','content':''}" rowid="PMS_FullLoad">  
          <td class="province" rowspan="1" colspan="3">
              ...
              <input name="ToName" f-options="{'code':'ToName','type':'text','etype':'','len':''}" verify="{'title':'【整车】目的省市区','required':true}" onclick="promptFromAddr('PMS_FullLoad')" type="text" readonly placeholder="请选择目的省市区" class="city_input inputFocus proCitySelAll"/>
                <input name="ToProvince" type="hidden" class="edit form-control transparent data" f-options="{'code':'ToProvince','type':'text','etype':'','len':''}" verify="" value="0">
                <input name="ToCity" type="hidden" class="edit form-control transparent data" f-options="{'code':'ToCity','type':'text','etype':'','len':''}" verify="" value="0">    
                <input name="ToDistrict" type="hidden" class="edit form-control transparent data" f-options="{'code':'ToDistrict','type':'text','etype':'','len':''}" verify="" value="0">                 
                <div class="provinceCityAll">
                    <div class="tabs clearfix">
                    <ul class="">
                        <li><a href="javascript:" class="current" tb="hotCityAll">热门城市</a></li>
    ...
    <tbody id="CityPickPrice" role="tab" class="tab-pane">
        ...
        <tr nrowkey="DetailID" style="height: 26px; display: none;" class="" fb-options="{'rowid':'CityPickPrice','initialRows':'','maxrows':'','content':''}" rowid="CityPickPrice">
         ...
         <td class="UnitType" colspan="">
          ...
          <td class="">
            <input name="Min" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Min','type':'text','etype':'','len':''}" verify="{'title':'【提货费】最小体积或重量','length':'','required':true}" value="0">
        </td>
          <td class="">
            <input name="Max" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Max','type':'text','etype':'','len':''}" verify="{'title':'【提货费】最大体积或重量','length':'','required':true}" value="0">
        </td>
        ...
        <td colspan="2">
            ...
            <input type="hidden" name="CarLength" readonly="" class="edit form-control transparent data" title="" value="0">
            <input type="hidden" name="CarVolume" readonly="" class="edit form-control transparent data" title="" value="0">
            <input type="hidden" name="CarWeight" readonly="" class="edit form-control transparent data" title="" value="0">
        </td>
          <td class="">
            <input name="Price" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Price','type':'number','etype':'','len':''}" verify="{'title':'【提货费】价格','length':'','required':true}" value="0">
          </td>
          <td class="">
    ...
    <tbody id="CityDeliveryPrice" role="tab" class="tab-pane">
        ...
        <tr nrowkey="DetailID" style="height: 26px;display: none;" class="" fb-options="{'rowid':'CityDeliveryPrice ','initialRows':'','maxrows':'','content':''}" rowid="CityDeliveryPrice">
        ...
        <input type="hidden" name="DocType" value="4" class="data" />
          ...
          <td class="">
            <input name="Min" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Min','type':'text','etype':'','len':''}" verify="{'title':'【送货费】最小体积或重量','length':'','required':true}" value="0">
        </td>
          <td class="">
            <input name="Max" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Max','type':'text','etype':'','len':''}" verify="{'title':'【送货费】最大体积或重量','length':'','required':true}" value="0">
        </td>
        <td class="CarType" colspan="">         
            <input type="hidden" name="CarType" readonly value="0" class="edit form-control transparent data" value="0">
         ...
         <td colspan="2">
          ...
          <td class="">
            <input name="Price" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Price','type':'number','etype':'','len':''}" verify="{'title':'【送货费】价格','length':'','required':true}" value="0">
          </td>
          <td class="">
    ...
    <tbody id="LoadPrice2" role="tab" class="tab-pane">
        ...
        <tr nrowkey="DetailID" style="height: 26px; display: none;" class="" fb-options="{'rowid':'LoadPrice2','initialRows':'','maxrows':'','content':''}" rowid="LoadPrice2">
          <td class="DocType" rowspan="1" colspan="1">
            <input type="hidden" name="DetailID" value="0" class="data" />
            <input type="hidden" name="DocType" class="data" value="0">
            <select name="DocType_id" class="edit transparent selectCarr show-tick form-control" data-live-search="true" onchange="pushDisplayValue(this);_DoComboLinking(this);" f-options="{'code':'DocType_id','type':'combobox','etype':'','len':''}" verify="{'title':'【装卸费】报价类型','required':true}">
              <option value="">---------------------------</option>
          ...
          <td class="UnitType" colspan="1">
            <input type="hidden" name="UnitType" class="data" value="0">
		    <select name="UnitType_id" class="edit transparent selectCarr show-tick form-control" data-live-search="true" onchange="pushDisplayValue(this);_DoComboLinking(this);Unit(this)" f-options="{'code':'UnitType_id','type':'combobox','etype':'','len':''}" verify="{'title':'【装卸费】单位类型','length':'','required':true}">
		      <option value="">-------------------------</option>
		      <option value="1">重量</option>
		      <option value="2">体积</option>
		      <option value="3">数量</option>
          ...
          <td class="Unit" colspan="2">
            <input type="hidden" name="Unit" class="data">   
		    <select name="Unit_id" class="edit transparent selectCarr show-tick form-control" data-live-search="true" onchange="pushDisplayValue(this);_DoComboLinking(this);UnitType(this)" f-options="{'code':'Unit_id','type':'combobox','etype':'','len':''}" verify="{'title':'【装卸费】单位','length':'','required':true}" value="0">
		      <option value="">-------------------------</option>
		      <!--#include file="/Controls/Unit.aspx"-->
		    </select>
          </td>
          <td class="" colspan="2">
            <input name="Min" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Min','type':'text','etype':'','len':''}" verify="{'title':'【装卸费】最小体积或重量','length':'','required':true}" value="0">
	      </td>
          <td class="" colspan="2">
            <input name="Max" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Max','type':'text','etype':'','len':''}" verify="{'title':'【装卸费】最大体积或重量','length':'','required':true}" value="0">
	      </td>
          <td class="" colspan="2">
            <input name="Price" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Price','type':'number','etype':'','len':''}" verify="{'title':'【装卸费】价格','length':'','required':true}" value="0">
          </td>
          <td class="" >
    ...
    <tbody id="MinPrice" role="tab" class="tab-pane">
        ...
        <tr style="height: 26px; display: none;" class="" fb-options="{'rowid':'MinPrice','initialRows':'','maxrows':'','content':''}" rowid="MinPrice">
          <td class="" rowspan="1" colspan="9" style="border-right:none;">
           ...
           <input name="Price" onkeyup="value=value.replace(/[^\d.]/g,'')" class="edit form-control transparent data" f-options="{'code':'Price','type':'number','etype':'','len':''}" verify="{'title':'【最低收费】价格','length':'','required':true}" value="0">
          </td>
    ...
    <tbody id="InsurancePrice" role="tab" class="tab-pane">
        ...
        <tr style="height: 26px; display: none;" class="" fb-options="{'rowid':'InsurancePrice','initialRows':'','maxrows':'','content':''}" rowid="InsurancePrice">
          <td class="" style="border-right:none;" colspan="">
            ...
            <input name="Price" onkeyup="value=value.replace(/[^\d.]/g,'')" placeholder="请输入百分比" class="edit form-control transparent data" f-options="{'code':'Price','type':'number','etype':'','len':''}" verify="{'title':'【保险费】价格','length':'','required':true}" value="0">
          </td>
    ...
    <tbody id="TaxPrice" role="tab" class="tab-pane">
        ...
        <tr style="height: 26px; display: none;" class="" fb-options="{'rowid':'TaxPrice','initialRows':'','maxrows':'','content':''}" rowid="TaxPrice">
          <td class="" style="border-right:none;" colspan="">
            ...
            <input  name="Price" onkeyup="value=value.replace(/[^\d.]/g,'')" placeholder="请输入百分比" class="edit form-control transparent data" f-options="{'code':'Price','type':'number','etype':'','len':''}" verify="{'title':'【税费】价格','length':'','required':true}" value="0">
          </td>
        <td class="" style="border-left:none"  colspan="10">
        %
          </td>
          <!--td class="">
            <a href="javascript:void(0);" tar="TaxPrice" class="button edit" onclick="delTr(this)" f-options="{'code':'','type':'_button','etype':'','len':''}" verify="">删除</a>
          </td-->
        </tr>
        <tr>
            <td rowspan="1" colspan="11" style="background-color: white; border: 0; height: 15px;"></td>
    ...
    <tbody>
     ...
     <tr>
        <td colspan="11" style="height:100px;">
          <textarea name="Description" style="line-height: 28px;height:100px;"  class="edit form-control transparent" f-options="{'code':'Description','type':'richtext','etype':'','len':''}" verify="{'title':'Description','length':'','textarea1':true}">0</textarea>
        </td>
    </tr>
    <tr>
        <td rowspan="1" colspan="11" style="background-color: white; border: 0; height: 15px;"></td>
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        initTableForm( $( '#25ccf24c-9c73-44a5-899b-2565511d81d0' ), false, function () {            
            ...
            setTimeout( 'CarName();RowAddPrice();autoHead();hoverTips();', 300 );  
        })
        ...
        $( '.title1 li a[role="tab"]' ).click( function ()
        {
        ...
        $( '#KG input, #Ton input, #CMetre input, #Square input, #num input' ).change( function ()
        {
            ...
            {                
                ...
                if ( name == 'num' )
                {
                    $( 'li a[aria-controls="' + name + '"]' ).nextAll().find( 'button' ).attr( 'style', 'color:#DF771E' );
					$( 'li a[aria-controls="' + name + '"]' ).nextAll().find( 'button .filter-option' ).attr( 'style', 'color:#DF771E' );
                }
            }
            else
            {
        ...
        $( document ).on( "change", "tr[nrowid=\"PMS_FullLoad\"] input, tr[nrowid=\"CityPickPrice\"] input, tr[nrowid=\"CityDeliveryPrice\"] input, tr[nrowid=\"LoadPrice2\"] input, tr[nrowid=\"MinPrice\"] input, tr[nrowid=\"InsurancePrice\"] input, tr[nrowid=\"TaxPrice\"] input", function ( event )
        {
            ...
            var stat = false;
            if ($(this).val() != '') {
                $('li a[aria-controls="' + name + '"]').attr('style', 'color:#DF771E');
            }
            else {
                $('#' + name).find('tr').each(function (index) {
                    for (var i = 0; i < $('#' + name).find('tr').eq(index).find('td').length; i++) {
