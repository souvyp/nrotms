...
<script language="javascript">
    var __saveNdtCfg = '{"main":{"insertVml":"tms_0226","updateVml":"tms_0226","queryVml":"pml_0038"}}';
</script>
 <table class="FormTable Y_alter" style="width:100%;" id="25ccf24c-9c73-44a5-899b-2565511d81d0" path="Price/eyxhzqmm" code="eyxhzqmm">
  ...
  <tbody>
    ...
    <tr style="height: 26px;">
      ...
      <td class="yesorno" rowspan="1" colspan="2">
        <input type="hidden" name="IsDelivery" value="0"/>
         <input name="DeliveryName" readonly class="edit form-control transparent" f-options="{'code':'DeliveryName','type':'text','etype':'editable','len':'50'}" verify="{'title':'DeliveryName','length':'50','required':true}">
      </td>
    ...
    <tr style="height: 26px; display: none;" nrowkey="DetailID" class="AdditionPrice" fb-options="{'rowid':'MinPrice','initialRows':'','maxrows':'','content':''}" rowid="AdditionPrice">
      ...
      <td class="">
        <a href="javascript:void(0);" tar="AdditionPrice" class="button edit" onclick="DelPrice(this, 'pml_0018')" f-options="{'code':'','type':'_button','etype':'','len':''}" verify="{'title':'','length':'','textarea1':true}">删除</a>
      </td>
    </tr>
      <tr>
        <td rowspan="1" colspan="10" style="background-color: white; border: 0; height: 15px;"></td>
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        setTimeout("initTableForm($('#25ccf24c-9c73-44a5-899b-2565511d81d0')),autoHead()", 100);//初始化固定头部的宽度

        var _docid = getUrlParam( 'id' );
        setTimeout("SetOrderID();rowAdd();OrderPriceShow("+ _docid +");hoverTips();", 1000);
