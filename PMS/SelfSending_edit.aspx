...
<html>
<head>		
<title>按单报价编辑- <%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<script language="javascript">
    var __saveNdtCfg = '{"main":{"insertVml":"tms_0226","updateVml":"tms_0226","queryVml":"pml_0035"}}';
</script>
 <table class="FormTable Y_alter areaTable" style="width:100%;" id="cf7f9153-cb57-415d-8a41-6a4695b6dd1a" path="Price/iqoicoqa" code="iqoicoqa">
  ...
  <tbody>
      ...
      <td colspan="5" style="border: 0;">
        ...
        <div class="toolbar">
          <div style="text-align:right;" class="button_workflow">
            <a class="btn btn-red footKeepBtn" onclick="NoZero(this)" href="javascript:void(0);" >保存&nbsp;<span class="glyphicon glyphicon-floppy-disk"></span></a>
    ...
    <tr class="CombineOrderPrice" style="height: 26px;">
      <td class="nozero">
        <input name="LessLoadPrice" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'LessLoadPrice','type':'number','etype':'','len':''}" verify="{'title':'LessLoadPrice','length':'','required':true,'textarea1':true}">
      </td>
      <td class="nozero">
        <input name="FullLoadPrice" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'FullLoadPrice','type':'number','etype':'','len':''}" verify="{'title':'FullLoadPrice','length':'','required':true,'textarea1':true}">
      </td>
      <td class="nozero">
        <input name="PickPrice" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'PickPrice','type':'number','etype':'','len':''}" verify="{'title':'PickPrice','length':'','required':true,'textarea1':true}">
      </td>
       <td class="nozero">
        <input name="DeliveryPrice" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'DeliveryPrice','type':'number','etype':'','len':''}" verify="{'title':'DeliveryPrice','length':'','required':true,'textarea1':true}">
      </td>
      <td class="nozero">
        <input name="OnLoadPrice" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'OnLoadPrice','type':'number','etype':'','len':''}" verify="{'title':'OnLoadPrice','length':'','required':true,'textarea1':true}">
      </td>
      <td class="nozero">
        <input name="OffLoadPrice" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'OffLoadPrice','type':'number','etype':'','len':''}" verify="{'title':'OffLoadPrice','length':'','required':true,'textarea1':true}">
      </td>
      <td class="nozero">
        <input name="AdditionPrice" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'AdditionPrice','type':'number','etype':'','len':''}" verify="{'title':'AdditionPrice','length':'','required':true,'textarea1':true}">
      </td>
      <td class="nozero">
        <input name="InsuranceCost" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'InsuranceCost','type':'number','etype':'','len':''}" verify="{'title':'InsuranceCost','length':'','required':true,'textarea1':true}">
      </td>
      <td class="nozero" colspan="">
        <input name="TaxPrice" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'TaxPrice','type':'number','etype':'','len':''}" verify="{'title':'TaxPrice','length':'','required':true,'textarea1':true}">
      </td>
      <td class="nozero"  colspan="">
    ...
    <tr style="height: 26px;height:100px;">
        <td colspan="10">
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        setTimeout( 'rowAdd();SetOrderID();hoverTips();TrackDetail('+ getUrlParam("id") +')', 2000 );
        

        var _sending = getUrlParam('sending');
        if (_sending) {
