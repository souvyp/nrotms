        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="position:absolute; top:0; width:100%; padding-bottom:0;">
                    <button type="button" class="btn btn-default  okButton footKeepBtn" style="margin-right:8px; box-shadow:none;" aria-label="OK" title="确定" onclick="SendDoc( 'SelfSending' )"><span aria-hidden="true" class="">确定</span><span class="glyphicon glyphicon-ok" style="margin-left: 2px;"></span></button>
    ...
    <div class="modal fade" id="ClosedModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="position:absolute; top:0; width:100%; padding-bottom:0;">
					<button type="button" class="btn btn-default  okButton footKeepBtn" style="margin-right:8px; box-shadow:none;" aria-label="OK" title="确定" onclick="CloseDoc('SelfClosed')" ><span aria-hidden="true" class="">确定</span><span class="glyphicon glyphicon-ok" style="margin-left:2px;"></span></button>
					<button type="button" class="btn btn-default " data-dismiss="modal" aria-label="Close" title="关闭" style="box-shadow:none;margin-left:0;"><span aria-hidden="true" class="">关闭</span><span class="glyphicon glyphicon-remove" style="margin-left:2px;color:#888;"></span></button>
                </div>
            </div>
            <!-- /.modal-content -->
			...
			{{each data}}
				<tr>
					...
					<td class="title" title="{{$value.code}}" fld="code" title="{{$value.code}}">
                        {{if $value.type == 1}}
                            <a  href="SelfSending_edit.aspx?id={{$value.id}}" title="{{$value.code}}">{{$value.code}}
                        {{else if $value.type == 3}}
                            <a  href="SelfAdditionSend_edit.aspx?id={{$value.id}}&OrderID={{$value.OrderID}}" title="{{$value.code}}">{{$value.code}}
                        {{else if $value.type == 4}}
                            <a  href="SelfSendingCombined_edit.aspx?id={{$value.id}}" title="{{$value.code}}">{{$value.code}}
                        {{else if $value.type == 5}}
                            <a  href="SelfSendAddCombined_edit.aspx?id={{$value.id}}&OrderID={{$value.OrderID}}" title="{{$value.code}}">{{$value.code}}
                        {{/if}}
                    </td>
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "SelfSending", "/Widget.aspx?param=jplist&vid=grid_jplist_0101");
