...
<script language="javascript">
    var __saveNdtCfg = '{"main":{"insertVml":"tms_0226","updateVml":"tms_0226","queryVml":"pml_0035"},"AdditionPrice":{"queryVml":"city_addition_query","deleteVml":"pml_0018"}}';
</script>
  ...
  <tbody>
    ...
    <tr style="height: 26px; display: none;" nrowkey="DetailID" class="AdditionPrice" fb-options="{'rowid':'MinPrice','initialRows':'','maxrows':'','content':''}" rowid="AdditionPrice">
      <td class="" rowspan="1" colspan="2">
        ...
        <input name="Price" onkeyup="value=value.replace(/[^\d.-]/g,'')" class="edit form-control transparent" f-options="{'code':'Price','type':'number','etype':'','len':''}" verify="{'title':'Price','length':'50','required':true}">
      </td>
