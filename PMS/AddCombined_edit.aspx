...
<script language="javascript">
    var __saveNdtCfg = '{"main":{"insertVml":"tms_0226","updateVml":"tms_0226","queryVml":"pml_0038"},"OrderContains":{"insertVml":"","updateVml":"","queryVml":"pml_0034","deleteVml":""}}';
</script>
 <table class="FormTable Y_alter" style="width:100%;" id="cf7f9153-cb57-415d-8a41-6a4695b6dd1a" path="Price/iqoicoqa" code="iqoicoqa">
  ...
  <tbody>
    ...
    <tr style="height: 26px;">
      ...
      <td class="backgroundGray" rowspan="1" colspan="1">合同编号</td>
    ...
    <input type="hidden" name="DetailID" value="0" />
      ...
      <td class="">
        <a href="javascript:void(0);" tar="AdditionPrice" class="button edit" onclick="DelPrice(this, '1')" f-options="{'code':'','type':'_button','etype':'','len':''}" verify="{'title':'','length':'','textarea1':true}">删除</a>
      </td>
    </tr>
      <tr>
        <td rowspan="1" colspan="10" style="background-color: white; border: 0; height: 15px;"></td>
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        setTimeout( 'CarName();rowAdd();SetOrderID();OrderPriceShow('+ _docid +');hoverTips()', 2000 );
        setTimeout( 'hoverTips()', 2500 );
