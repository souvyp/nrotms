...
<html>
<head>		
<title>合单报价编辑- <%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<script language="javascript">
    var __saveNdtCfg = '{"main":{"insertVml":"tms_0226","updateVml":"tms_0226","queryVml":"pml_0035"},"OrderContains":{"insertVml":"","updateVml":"","queryVml":"pml_0036","deleteVml":""}}';
</script>
 <table class="FormTable Y_alter" style="width:100%;" id="cf7f9153-cb57-415d-8a41-6a4695b6dd1a" path="Price/iqoicoqa" code="iqoicoqa">
  ...
  <tbody>
    ...
    <tr class="CombineOrderPrice" style="height: 26px;">
      <td class="">
        <input name="LessLoadPrice" class="edit form-control transparent price" f-options="{'code':'LessLoadPrice','type':'number','etype':'','len':''}" verify="{'title':'LessLoadPrice','length':'','textarea1':true}">
      </td>
      <td class="">
        <input name="FullLoadPrice" class="edit form-control transparent price" f-options="{'code':'FullLoadPrice','type':'number','etype':'','len':''}" verify="{'title':'FullLoadPrice','length':'','textarea1':true}">
      </td>
      <td class="">
        <input name="PickPrice" class="edit form-control transparent price" f-options="{'code':'PickPrice','type':'number','etype':'','len':''}" verify="{'title':'PickPrice','length':'','textarea1':true}">
      </td>
       <td class="">
        <input name="DeliveryPrice" class="edit form-control transparent price" f-options="{'code':'DeliveryPrice','type':'number','etype':'','len':''}" verify="{'title':'DeliveryPrice','length':'','textarea1':true}">
      </td>
      <td class="">
        <input name="OnLoadPrice" class="edit form-control transparent price" f-options="{'code':'OnLoadPrice','type':'number','etype':'','len':''}" verify="{'title':'OnLoadPrice','length':'','textarea1':true}">
      </td>
      <td class="">
        <input name="OffLoadPrice" class="edit form-control transparent price" f-options="{'code':'OffLoadPrice','type':'number','etype':'','len':''}" verify="{'title':'OffLoadPrice','length':'','textarea1':true}">
      </td>
      <td class="">
        <input name="AdditionPrice" class="edit form-control transparent price" f-options="{'code':'AdditionPrice','type':'number','etype':'','len':''}" verify="{'title':'AdditionPrice','length':'','textarea1':true}">
      </td>
      <td class="">
        <input name="InsuranceCost" class="edit form-control transparent price" f-options="{'code':'InsuranceCost','type':'number','etype':'','len':''}" verify="{'title':'InsuranceCost','length':'','textarea1':true}">
      </td>
      <td class="" >
        <input name="TaxPrice" class="edit form-control transparent price" f-options="{'code':'TaxPrice','type':'number','etype':'','len':''}" verify="{'title':'TaxPrice','length':'','textarea1':true}">
      </td>
...
<script type="text/javascript">
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        setTimeout('priceOnly()', 1000);
        setTimeout('CarName();SetOrderID();hoverTips()', 2000);
        ...
        if (getUrlParam('code') == 'VerifiedDoc') {
            $('.saveBtn').css('display', 'none');
            $('.sendBtn').css('display', 'none');
        }
...
<script type="text/javascript">
    ...
    function priceOnly() {
        if (getUrlParam('code') == 'VerifingDoc' || getUrlParam('code') == "MyClosed" || getUrlParam('code') == "MySearch" || getUrlParam('code') == "VerifiedDoc" || getUrlParam('code') == "VerifySearch") {
            $('tr[nrowid="CombineOrderPrice"]').find('input').attr('readonly',true);
