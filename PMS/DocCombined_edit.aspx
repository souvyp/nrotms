 ...
 <table class="FormTable Y_alter" style="width:100%;" id="cf7f9153-cb57-415d-8a41-6a4695b6dd1a" path="Price/iqoicoqa" code="iqoicoqa">
  ...
  <tbody>
    ...
    <tr class="CombineOrderPrice" style="height: 26px;">
						...
						<td class="">
							<input id="td7" tabindex="8" name="InsuranceCost" onkeyup="sumTotalPrice(this)" class="edit form-control transparent price" f-options="{'code':'InsuranceCost','type':'number','etype':'','len':''}" verify="{'title':'InsuranceCost','length':'','textarea1':true}">
						</td>
						<td class="" >
