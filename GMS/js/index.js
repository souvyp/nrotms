	...
	$('.' + className).highcharts({
		...
		plotOptions: {
			column: {
				...
				borderWidth: 0,
 				dataLabels:{
                    enabled:true, // dataLabels设为true  显示数据
                    style:{
                         color:'#666'
                    } 
                }				
...
//柱形图   横
function ColumnChart_c(className, ShowStart, ShowEnd, chartsName, series, StatName) //类名，起始时间，名称，数据,统计名称
{
...
//饼图图
function ColumnChart_b(className, ShowStart, ShowEnd, chartsName, series, StatName) //类名，起始时间，名称，数据,统计名称
{
	$('.' + className).highcharts({
		chart: {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0017","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					ColumnChart('highcharts', year, year , chartsName, series, '集团营业额-总览报表');
				} else {
					$('.jplistYL').html("");
...
//  长途  市内     营业额
function Long_Distance_yye() {

	//	var company = 10351;
var company = $('#Span2').text();
	var end = $(".year_").val();
 	
    var shipmode = $(".long_active").val();
    
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0020","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"},{"name":"shipmode","value":"' + shipmode + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团营业额-长途报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
//费用类型     营业额
function Expense_Type_yye() {
	//	var company = 10351;
var company = $('#Span2').text();	
	var end = $(".year_").val();
 
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0019","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
...
//				$('.jplistYL').html('');
				...
				if(length != 0) {
					...
					for(var j=0;j < data[0].rs[0].rows.length;j++){
						chartsName.push(data[0].rs[0].rows[j].Type);
					}
					
					var chartsTotal = [];
					var year = end;
					for(var i = 0; i < data[0].rs[0].rows.length; i++) {
						chartsTotal.push(parseFloat(data[0].rs[0].rows[i].Amount));						 
					}
					var series = [];
					series[0] = {
						name: '金额(万元)',
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团营业额-费用类型报表');
				} else {
					_html += '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
					$('.hr_charts').addClass('hide');
...
//  整车    零担   营业额
function Vehicle_Transportation_yye() {
		...
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团营业额-整车报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
//客户统计    营业额
function Customer_Statistics_yye() {

var company = $('#Span2').text();
	//	var company = 10351;
	var end = $(".year_").val();
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0018","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				var length = data[0].rs.length;
				if(length != 0) {
					var hei = data[0].rs[0].rows.length;
					var chartsName = [];
					for(var i = 0; i < data[0].rs[0].rows.length; i++) {
						chartsName.push(data[0].rs[0].rows[i].ComapanyName);
					}
					...
					if(data[0].rs[0].rows.length > 10){
						$('.highcharts').css("height", hei * 40 + "px");	
					}
					$('.hr_charts').removeClass('hide');
					ColumnChart_c('highcharts', year, year , chartsName, series, '集团营业额-客户统计报表');
...
//线路统计     营业额
function Line_Statistics_yye() {

var company = $('#Span2').text();
	//	var company = 10351;
	var end = $(".year_").val();
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0023","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					var chartsName = [];
					for(var i = 0; i < data[0].rs[0].rows.length; i++) {
						chartsName.push(data[0].rs[0].rows[i].fromcity + data[0].rs[0].rows[i].tocity);
					}
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_c('highcharts', year, year , chartsName, series, '集团营业额-线路统计报表');
...
//分公司  统计    营业额
function branch_company_Report_yye() {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0016","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					for(var i = 0; i < data[0].rs[0].rows.length; i++){
					    arrays[i] = {
					        name:data[0].rs[0].rows[i].ComapanyName,
					        y:parseFloat(data[0].rs[0].rows[i].TotalCost)
					    }
					}
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_b('highcharts', end, end , chartsName, series, '集团营业额-分公司统计报表');
				} else {
					_html += '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
					$('.hr_charts').addClass('hide');
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0032","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团成本-总览报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0035","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"},{"name":"shipmode","value":"' + shipmode + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团成本-长途报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
//费用类型     成本
function Expense_Type_cb() {
	//	var company = 10351;
var company = $('#Span2').text();	
	var end = $(".year_").val();
 
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0034","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
...
//				$('.jplistYL').html('');
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团成本-费用类型报表');
				} else {
					_html += '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
					$('.hr_charts').addClass('hide');
...
//  整车    零担   成本
function Vehicle_Transportation_cb() {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0036","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"},{"name":"transportmode","value":"' + transportmode + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团成本-整车报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
//客户统计    成本
function Customer_Statistics_cb() {

var company = $('#Span2').text();
	//	var company = 10351;
	var end = $(".year_").val();
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0033","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_c('highcharts', year, year , chartsName, series, '集团成本-客户统计报表');
...
//线路统计     成本
function Line_Statistics_cb() {

var company = $('#Span2').text();
	//	var company = 10351;
	var end = $(".year_").val();
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0038","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_c('highcharts', year, year , chartsName, series, '集团成本-线路统计报表');
...
//分公司  统计    成本
function branch_company_Report_cb() {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0031","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_b('highcharts', end, end , chartsName, series, '集团成本-分公司统计报表');
				} else {
					_html += '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
					$('.hr_charts').addClass('hide');
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0041","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团利润-总览报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0044","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"},{"name":"shipmode","value":"' + shipmode + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团利润-长途报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
//费用类型     利润
function Expense_Type_lr() {
	//	var company = 10351;
var company = $('#Span2').text();	
	var end = $(".year_").val();
 
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0043","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
...
//				$('.jplistYL').html('');
				...
				if(length != 0) {
					...
					var year = end;
					for(var i = 0; i < data[0].rs[0].rows.length; i++) {
						chartsTotal.push(parseFloat(data[0].rs[0].rows[i].profit));						 
					}
					var series = [];
					series[0] = {
						name: '金额(万元)',
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团利润-费用类型报表');
				} else {
					_html += '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
					$('.hr_charts').addClass('hide');
...
//  整车    零担   利润
function Vehicle_Transportation_lr() {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0045","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"},{"name":"transportmode","value":"' + transportmode + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '集团利润-整车报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
//客户统计    利润
function Customer_Statistics_lr() {

var company = $('#Span2').text();
	//	var company = 10351;
	var end = $(".year_").val();
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0046","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_c('highcharts', year, year , chartsName, series, '集团利润-客户统计报表');
...
//线路统计     利润
function Line_Statistics_lr() {

var company = $('#Span2').text();
	//	var company = 10351;
	var end = $(".year_").val();
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0042","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_c('highcharts', year, year , chartsName, series, '集团利润-线路统计报表');
...
//分公司  统计    利润
function branch_company_Report_lr() {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0040","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_b('highcharts', end, end , chartsName, series, '集团利润-分公司统计报表');
				} else {
					_html += '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
					$('.hr_charts').addClass('hide');
...
//     应收栏目     应收栏目                                      应收栏目                                应收栏目       应收栏目

//集团营业总额        应收
function Group_t_Report_ys() {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0027","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '应收账款-集团总览报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
//客户统计     应收
function Customer_Statistics_ys() {

var company = $('#Span2').text();
	//	var company = 10351;
	var end = $(".year_").val();
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0026","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_c('highcharts', year, year , chartsName, series, '应收账款-客户统计报表');
...
//分公司  统计   应收
function branch_company_Report_ys() {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0025","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_b('highcharts', end, end , chartsName, series, '应收账款-分公司统计报表');
				} else {
					_html += '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
					$('.hr_charts').addClass('hide');
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0028","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart('highcharts', year, year , chartsName, series, '应付账款-集团总览报表');
				} else {
					$('.jplistYL').html("");
					_html = '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
...
//客户统计   应付
function Customer_Statistics_yf() {

var company = $('#Span2').text();
	//	var company = 10351;
	var end = $(".year_").val();
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0030","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_c('highcharts', year, year , chartsName, series, '应付账款-客户统计报表');
...
//分公司  统计      应付
function branch_company_Report_yf() {
...
var company = $('#Span2').text();
	...
	var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0029","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"}]}]';
	NSF.System.Network.Ajax('/Portal.aspx',
		vml,
		'POST',
		false,
		function(result, data) {
			if(result) {
				...
				if(length != 0) {
					...
					$('.hr_charts').removeClass('hide');
					ColumnChart_b('highcharts', end, end , chartsName, series, '应付账款-分公司统计报表');
				} else {
					_html += '<tr><td colspan="13" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
					$('.highcharts').html(_html);
					$('.hr_charts').addClass('hide');
...
function OCPro()
{
    ...
    if ( start != '' && end != '' )
    {
        var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0010","paras":[{"name":"starttime","value":"' + start + ' 00:00:00"},{"name":"endtime","value":"' + end + ' 23:59:59"}]}]';
    	NSF.System.Network.Ajax('/Portal.aspx',
            vml,
            'POST',
            false,
            function ( result, data )
            {
                if ( result )
                {
                    ...
                    {
                        _html += '<tr><td colspan="10" style="text-align:center !important">该时间段没有数据！！！</td></tr>';
                        $('.highcharts').html(_html);
                        $('.hr_charts').addClass('hide');
                    }
                    $( '.jplistYL' ).append( _html );
