...
<html>
<head>		
<title>应付账款-客户统计报表-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<body code="yf_Customer_Statistics">  
<style type="text/css">
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
               <p class="mainHtml_tit">应付账款-客户统计报表</p>
            </div>
            <select class="year_"  onchange="Customer_Statistics_yf()">
