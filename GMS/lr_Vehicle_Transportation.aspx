...
<html>
<head>		
<title>集团利润-整车·零担报表-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<body code="lr_Vehicle_Transportation">  
<style type="text/css">
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
               <p class="mainHtml_tit">集团利润-整车·零担报表</p>
            </div>
 						...
 						<select class="year_" style="margin:0 12px;" onchange="Vehicle_Transportation_lr()">
