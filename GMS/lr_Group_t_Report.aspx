...
<html>
<head>		
<title>集团利润-总览报表-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
               <p class="mainHtml_tit">集团利润-总览报表</p>
            </div>
            <select class="year_"  onchange="Group_t_Report_lr()">
            ...
            <div>
            	<table class="jptable table table-border">
            		...
            		<tbody style="text-align: center;" class="jplistYL" >
