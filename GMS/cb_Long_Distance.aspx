...
<html>
<head>		
<title>集团成本-长途·市内-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
               <p class="mainHtml_tit">集团成本-长途·市内报表</p>
            </div>
 						...
 						<select class="year_" style="margin:0 12px;" onchange="Long_Distance_cb()">
...
<script type="text/javascript">
	$(document).on('click', '.long_b', function() {
		...
		var vml = '[{"namespace":"protocol","cmd":"data","version":1,"id":"rms_0035","paras":[{"name":"company","value":"' + company + '"},{"name":"Year","value":"' + end + '"},{"name":"transportmode","value":"' + transportmode + '"}]}]';
