...
<html>
<head>		
<title>集团营业额-客户统计-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
<meta charset="utf-8" />
...
<!--<><><><><><><><><><><><><><><><><><><><><><><><><><> 数据列表开始 <><><><><><><><><><><><><><><><><><><><><><><><><><>-->
		<div id="demo" class="box jplist">
            ...
            <div class="maintitle_container">
               <p class="mainHtml_tit">集团营业额-客户统计报表</p>
            </div>
            <select class="year_ selectpicker"  onchange="Customer_Statistics_yye()">
...
//      InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "Index", "/Widget.aspx?param=jplist&vid=grid_jplist_0096");

        resizeCols = setInterval('resizeTable()', 200);
    	Customer_Statistics_yye();
