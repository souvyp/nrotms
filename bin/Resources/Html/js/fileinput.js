...
(function (factory) {
    ...
    tCaption = '<div tabindex="500" class="form-control file-caption {class}">\n' +
        ...
        '</div>\n';
    //noinspection HtmlUnknownAttribute  change:hide
    tBtnDefault = '<button type="{type}" tabindex="500" title="{title}" class="{css} hide" {status}>{icon} {label}</button>';
    ...
    tActions = '<div class="file-actions">\n' +
        ...
        '</div>';
    //noinspection HtmlUnknownAttribute
    tActionDelete = '<button type="button" class="kv-file-remove {removeClass}" ' + 'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}删除</button>\n';
    tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
        '{uploadIcon}上传</button>';
    tActionZoom = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}放大</button>';
