...
_29(e,"mousedown");
if($.fn.draggable.isDragging||$.fn._resizable.isResizing){
e.preventDefault();
}
};
function _2a(e){
...
$(this).__draggable({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).__draggable({disabled:true});
});
}};
...
_e7.disabledNodes=[];
_e8.dnd=true;
_e9.find("div.tree-node").__draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_ea){
...
$(this).__draggable("proxy").css({left:-10000,top:-10000});
...
var _fe=$(_fc).__draggable("proxy").find("span.tree-dnd-icon");
...
return $.extend({},$.fn.panel.parseOptions(_28e),$.parser.parseOptions(_28e,[{draggable:"boolean",_resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable:true,_resizable:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _28f(_290){
...
$.fn.dialog.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",collapsible:false,minimizable:false,maximizable:false,_resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
function _2a1(){
...
function _2a4(_2a5){
var opts=$.extend({},$.messager.defaults,{modal:false,shadow:false,draggable:false,_resizable:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},title:"",width:250,height:100,showType:"slide",showSpeed:600,msg:"",timeout:4000},_2a5);
...
_a49.find("a.slider-handle").__draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
