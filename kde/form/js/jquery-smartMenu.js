		...
		$(this).each(function() {
			this.oncontextmenu = function(e) {
				...
				if (jqueryMenu) {
					...
					var jqueryMenuHeight='';
					jqueryMenuHeight=jqueryMenu.css('height');
					jqueryMenuHeight=jqueryMenuHeight.replace('px','');
					
					jqueryMenu.css({
						display: "block",
						left: e.clientX + params.offsetX,
						top: e.clientY + st + params.offsetY - jqueryMenuHeight
					});
