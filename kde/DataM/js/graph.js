...
function showProperties(graph, parent,cell,isTable,isNew)
{
	...
	if(isTable){
		...
		showModalWindow("数据表属性",'Dataset',450,250,function(){return putPropertys(graph,parent,cell,isTable,isNew)});
	}
	else{
		...
		showModalWindow("字段",'Field',450,320,function(){return putPropertys(graph,parent,cell,isTable,isNew)});	
	}
};
