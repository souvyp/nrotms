...
//初始化区域图的对象
	...
	if(property.haveTool){
		...
		toolWidth=31;
		this.$nowType="cursor";
		var additional = '<span><hr /></span><a href="javascript:;" id="'+this.$id+'_btn_multi" class="GooFlow_tool_btn"><b class="flow-ico-multi"/></a><a href="javascript:;" id="'+this.$id+'_btn_top" class="GooFlow_tool_btn"><b class="flow-ico-align-top"/></a><a href="javascript:;" id="'+this.$id+'_btn_left" class="GooFlow_tool_btn"><b class="flow-ico-align-left"/></a>';
		this.$tool.append(additional);
		//绑定各个按钮的点击事件
	...
	if(this.$editable){
	  this.$workArea.on("click",{inthis:this},function(e){
		...
		e.data.inthis.addNode(e.data.inthis.$max,{name:"item_"+e.data.inthis.$max,left:X,top:Y,type:e.data.inthis.$nowType});
		e.data.inthis.$max++;
	  });
	  //划线时用的绑定
	  ...
	  this.$lineMove.on("mousedown",{inthis:this},function(e){
		  ...
		  var This=e.data.inthis;
		  var ev=mousePosition(e),t=getElCoordinate(This.$workArea[0],true);
		  var X,Y;
...
GooFlow.prototype={
	...
	initDraw:function(id,width,height){
		...
		$(this.$draw).delegate(tmpClk,"dblclick",{inthis:this},function(e){
			...
			var t=getElCoordinate(This.$workArea[0],true);
	...
	initWorkForNode:function(){
		...
		this.$workArea.delegate(".GooFlow_item","mousedown",{inthis:this},function(e){
			var This=e.data.inthis;
			if(This.$nowType!="direct")	return;
			var ev=mousePosition(e),t=getElCoordinate(This.$workArea[0],false);
			var X,Y;
			X=ev.x-t.left+This.$workArea[0].parentNode.scrollLeft;
			Y=ev.y-t.top+This.$workArea[0].parentNode.scrollTop;
