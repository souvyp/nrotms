<script>
	var MENU_DEF_ZMMP = "<%=MindMapMenuUrl("tms")%>";//"/Resources/UI/tms.zmmp";
    function initHeader()
    {
        loadJSS( 
		[
            '/TMS/js/SinceWriting.js'
		] );
    }
    function showqrcode(){
                ...
                <div class="topbar-left">
                    <div class="dropdown topbar-notice topbar-btn topbar-left">
                        ...
                        <div class="topbar-notice-panel" style="width:300px; left:-120px;">
							...
							<div class="topbar-notice-head topBarNav">
                                <ul class="nav nav-tabs" id="myTab">
								  <li class="active"><a href="#home">我的消息</a></li>
								  <li><a href="#profile">我的待办</a></li>
								</ul>
                            </div>
                            <div class="topbar-notice-body">
                                <div class="tab-content">
									 <div class="tab-pane active" id="home">
										<div>
											<ul name="MyEvents">
												<li view-fld='{fld:"Event_Type",method:"template",template:"<div style=\"display:none;\"><span name=\"IsDistance\">@isdistance@</span><span name=\"Event_Result\">@event_result@</span><span name=\"Event_Type\">@event_type@</span><span name=\"Event_SrcCompanyName\">@event_srccompanyname@</span><span name=\"Event_DstCompanyName\">@event_dstcompanyname@</span><span name=\"Event_Ext\">@event_ext@</span></div><a  href=\"javascript:void(0)\"  style=\"display:block;height:100%;padding:10px 10px;background:#fff;color:#333;\"  class=\"clearfix\"><span class=\"inline-block\"><span class=\"topbar-notice-link\" name=\"Event\"></span></span><span class=\"inline-block topbar-notice-class\"><span class=\"topbar-notice-class-name\" >@event_time@</span></span></span></a>"}'>
												</li>
											</ul>
										</div>
										<div class="topbar-notice-foot">
									...
									<div class="tab-pane" id="profile">
										<div>
											<ul name="WaitDoneEvent">
												<li view-fld='{fld:"Event_Type",method:"template",template:"<div style=\"display:none;\"><span name=\"Event_Category\">@event_category@</span><span name=\"IsLongDistance\">@islongdistance@</span><span name=\"Event_Result\">@event_result@</span><span name=\"Event_Type\">@event_type@</span><span name=\"Event_SrcCompanyName\">@event_srccompanyname@</span><span name=\"Event_DstCompanyName\">@event_dstcompanyname@</span><span name=\"Event_Ext\">@event_ext@</span></div><a  href=\"javascript:void(0)\"  style=\"display:block;height:100%;padding:10px 10px;background:#fff;color:#333;\"  class=\"clearfix\"><span class=\"inline-block\"><span class=\"topbar-notice-link\" name=\"WaitEvent\"></span></span><span class=\"inline-block topbar-notice-class\"><span class=\"topbar-notice-class-name\" >@event_time@</span></span></span></a>"}'>
												</li>
											</ul>
										</div>
										<div class="topbar-notice-foot">
											<a class="topbar-notice-more"  href="WaitDoneEvent.aspx">查看更多>></a>
										</div>
									</div>
								</div>
                            </div>
                            ...
                            <div class="topbar-notice-body" style="width:200px;">
                                <ul name="topbar-notice-head">
                                    <li class="topbar-info-btn" style="height:40px;">
                                        <a href="/TMS/faq.aspx" style="padding:0 10px; font-weight:normal;">
                                            <span>新版FAQ</span>
                                        </a>
                                    </li>
                                    <li class="topbar-info-btn" style="height:40px;">
                                        <a href="/TMS/help.aspx" style="padding:0 10px; font-weight:normal;">
                                            <span>帮助中心</span>
                                        </a>
                                    </li>
                                    <%--<li class="topbar-info-btn" style="height:40px;">
                            ...
                            <div class="topbar-left">
                                <div class="topbar-left">
                                    <div class="dropdown topbar-info-item">
                                        <a href="#" class="dropdown-toggle topbar-btn" data-toggle="dropdown" style="width:60px; text-align:center;">
                                            <span></span>
                                            <span class="glyphicon glyphicon-question-sign"></span>
                                        </a>
                                        <ul class="dropdown-menu" style="padding:0px; width:230%; margin-left:-50%;">
                            ...
                            <%--<a href="#" class="dropdown-toggle topbar-btn" data-toggle="dropdown" >
                                ...
                                <span class="login">
                                    <asp:Label ID="lblStatus" runat="server">
                                        <span class="zld_username"><%=GetTruename()%></span><span id="Span1" style="display:none"><% =GetUserID()%></span>
                                    </asp:Label>
                                </span>
                                <span class="icon-arrow-down"></span>
                            </a>--%>
            ...
            <div class="viewFramework-product-navbar">
                ...
                <div class="product-nav-stage product-nav-stage-main">
                    <div class="product-nav-scene product-nav-main-scene">
                        <%--<div class="product-nav-title">订单管理</div>
