<script>
	var MENU_DEF_ZMMP = "<%=MindMapMenuUrl("pms")%>";
    function initHeader()
    {
        loadJSS( 
		[
            '/PMS/js/SinceWriting.js'
		] );
    }
    function showqrcode(){
                    ...
                    <div class="topbar-left">
                        ...
                        <div class="dropdown topbar-info-item" >
                            ...
                            <ul class="dropdown-menu" style="padding:0px;" >
                                <li class="topbar-info-btn">
                                    <a href="UpdatePwd.aspx"><span>个人中心</span></a></li>
