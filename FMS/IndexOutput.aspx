...
<html>
	...
	<head>	
		<title>应收付账单导出-<%=NDS.Kits.Config.Instance.WebsiteParameters("ProductName")%></title>
		<meta charset="utf-8" />
	...
	<body onload="printtable()">
		<div class="title"><h1>应收对账单</h1></div>
		...
		<script>
			function printtable(){
				...
				var vml ='[{"namespace":"protocol","cmd":"data","version":1,"id":"fml_0007","paras":[{"name":"did","value":"'+ _did +'"}]}]';
