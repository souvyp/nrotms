			  ...
			  <tbody >
			    ...
			    <tbody id="FormTable">
					<tr style="height: 26px;" class="" fb-options="{'rowid':'','initialRows':'','maxrows':'','content':''}">
						<td class="td_name"  colspan="">订单编号</td>
						<td class="td_name" colspan="">合同号</td>
					...
					<tr   style="height: 26px;" IsDirty="true" class=""  class="" >
						<td colspan="4">
							合计
						</td>
						 <td>
...
<script type="text/javascript">
	...
	function sumPrint() {
        ...
        $('h4>span').text($('input[name="CustomerName"]').val());
        window.print();
