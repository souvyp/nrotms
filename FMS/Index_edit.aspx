 ...
 <table class="FormTable Y_alter" style="width:100%;" id="25ccf24c-9c73-44a5-899b-2565511d81d0" path="Price/eyxhzqmm" code="eyxhzqmm">
  ...
  <tbody>
    ...
    <tr style="height: 26px;">
	 ...
	 <tr style="height: 26px;">
       <td class="td_name">
         <a href="javascript:void(0);" onclick="indexOrder(this)" class="edit customer" f-options="{'code':'id','type':'dialogue','etype':'editable','len':'50','cls':'frame','url':'CustomerSelector.aspx','vals':'Customerid=id,customercompanyid=CompanyID,CustomerName=Name','modalWindow':'1'}" verify="{}">
             客户
	...
	<tr  nrowkey="DetailID"  style="height: 26px;display:none"  class="" fb-options="{'rowid':'Balance_BillDetails','initialRows':'1','maxrows':'10','content':''}" rowid="Balance_BillDetails">
	   ...
	   <td name="button" class="" style="text-align: right;">
			<a href="javascript:void(0);" tar="Balance_BillDetails" onclick="deleteOrder(this)" executecode="%23delete%23" class="button edit"  f-options="{'code':'','type':'_button','etype':'','len':''}" verify="{'title':'','length':'','textarea1':true}">删除</a>
		</td>
	</tr>
...
<script type="text/javascript">
    ...
    function indexOrder(aobj) {
    	...
    	if (_flg) {
    		...
    		$(aobj).attr('onclick', 'showModalWindow(this,"所属客户")');
    		$(aobj).click();
    	}
    }
