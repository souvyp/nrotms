		...
		<table class="jptable table table-border" id="demoList">
			...
			{{each data}}
				<tr>
	                ...
	                <td class="title"　 fld="id" title="{{$value.id}}"><a  href="AccountPayed_edit.aspx?id={{$value.id}}">{{$value.id}}</a></td>				
...
<script type="text/javascript">
    ...
    var reqeustDone = function () {		/*所有JS加载完成以后执行*/
        ...
        InitList($("#demo"), $("#demo .list"), $("#jplist-template").html(), "AccountPay", "/Widget.aspx?param=jplist&vid=grid_jplist_0122");
